...
return convertTri($num, 0);
  ...
  function Header()
 {
    ...
    $y = $this->GetY();
     ...
     $this->SetXY($x, $y+7);
     $this->Image('C:\Users\admin\Desktop\Work\LOGO-SIGNATURE_3.jpeg',58,16,11);
...
$sql_charges = "SELECT * 
                FROM  retail_proforma AS rp, retail_return_goods AS rg, mstr_item AS mi, retail_return_goods_items AS rgi, mstr_supplier AS ms
    ...
    $this->Cell(40,7,$row['103'],0,1,'L',0,false);  
    ...
    $this->SetFont('Arial','',9);
    $this->Cell(15,7,$row['29'],0,1,'L',0,false);
    ...
    $this->SetXY($x+19, $y);
    $this->SetFont('Arial','',9);
    $this->Cell(40,7,$row['4'],0,1,'L',0,false); 
    ...
    $this->SetXY($x+141, $y);
    $this->SetFont('Arial','',9);
    $this->Cell(15,7,$row['9'],0,1,'L',0,false);
    ...
    $this->SetFont('Arial','',9);
    $this->Cell(40,7,$row['5'],0,1,'L',0,false);
...
$this->Ln(2);
    ...
    $this->SetXY($x+15, $y);
    $this->SetFont('Arial','',9);
    $this->Cell(20,8,$row2['62'],0,1,'R',0,false);     // $row2['16']
