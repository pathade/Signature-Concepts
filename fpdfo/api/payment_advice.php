  ...
  function Header()
 {
    include('../../database/dbconnection.php');
     ...
     $pa_no=$_GET['paymentno'];
        ...
        $sql = "SELECT  fpa.id_pk, fpa.date, ms.supplier_id_fk, ms.name, ms.address
        FROM fin_payment_advice fpa, mstr_supplier ms 
        WHERE ms.supplier_id_fk = '$supplier_id'and fpa.id_pk = '$pa_no' ";
    ...
    //  $this->Image('C:\Users\admin\Desktop\Work\signature_2.jpg',65,16,15);
     ...
     $this->Cell(95,5,$row['3'],0,1,'L',0,false);

     $this->SetXY($x+99, $y+24);
     $this->SetFont('Arial','',8);
     $this->Cell(95,5,$row['4'],0,1,'L',0,false);

    //  $this->SetXY($x+99, $y+28);
    //  $this->SetFont('Arial','',8);
    //  $this->Cell(95,5,'(EAST),',0,1,'L',0,false);
    //  $this->SetXY($x+99, $y+32);
    //  $this->SetFont('Arial','',8);
    //  $this->Cell(95,5,'',0,1,'L',0,false);
  ...
  $y = $this->GetY();
    ...
    //  $this->Cell(15,13,' ',1,1,'L',0,false);  // CELL 9
     ...
     $this->SetXY($x+99, $y-1);
     $this->SetFont('Arial','',9);
     $this->Cell(17,15,' ',1,1,'L',0,false); // CELL 10
     $this->SetXY($x+99, $y-1);
     $this->SetFont('Arial','',9);
     $this->Cell(17,5,'Manual',0,1,'C',0,false); 
     $this->SetXY($x+99, $y+3);
     $this->SetFont('Arial','',9);
     $this->Cell(17,5,'Dr.Note',0,1,'C',0,false); 

     $this->SetXY($x+116, $y-1);
     $this->SetFont('Arial','',9);
     $this->Cell(17,15,' ',1,1,'L',0,false); // CELL 11
     $this->SetXY($x+116, $y-1);
     $this->SetFont('Arial','',9);
     $this->Cell(17,5,'Manual Cr',0,1,'C',0,false); 
     $this->SetXY($x+116, $y+3);
     $this->SetFont('Arial','',9);
     $this->Cell(17,5,'Note',0,1,'C',0,false); 
  
     $this->SetXY($x+133, $y-1);
     $this->SetFont('Arial','',9);
     $this->Cell(20,15,' ',1,1,'L',0,false); // CELL 12
     $this->SetXY($x+133, $y-1);
     $this->SetFont('Arial','',9);
     $this->Cell(20,5,'Advance',0,1,'C',0,false);
     ...
     $this->SetXY($x+173, $y-1);
     $this->SetFont('Arial','',9);
     $this->Cell(22,5,'Net',0,1,'C',0,false); 
     $this->SetXY($x+173, $y+3);
     $this->SetFont('Arial','',9);
     $this->Cell(22,5,'Amount To',0,1,'C',0,false); 
     $this->SetXY($x+173, $y+7);
     $this->SetFont('Arial','',9);
     $this->Cell(22,5,'Pay',0,1,'C',0,false); 
 
     $sql_charges2 ="SELECT *
     FROM fin_payment_advice_items
     WHERE fpa_id_fk = '$row[0]' ";
     ...
     $x = $this->GetX();
          ...
          $this->SetXY($x-5, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(15,10,$row2[4],1,1,'C',0,false);
    //  $this->SetXY($x-5, $y+8);
    //  $this->SetFont('Arial','',8);
    //  $this->Cell(15,4,'121',0,1,'C',0,false); 
    $sql_charges3 ="SELECT bill_date
     ...
     $this->SetXY($x+10, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(19,10,$row3[0],1,1,'C',0,false);

     $this->SetXY($x+29, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(20,10,$row2[16],1,1,'C',0,false);

     $this->SetXY($x+49, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(20,10,$row2[6],1,1,'R',0,false); 
     ...
     $this->SetXY($x+99, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(17,10,$row2[12],1,1,'R',0,false); 

    $this->SetXY($x+116, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(17,10,$row2[14],1,1,'C',0,false);

     $this->SetXY($x+133, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(20,10,$row2[15],1,1,'R',0,false);

     $this->SetXY($x+153, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(20,10,$row2[17]+$row2[19],1,1,'R',0,false);  

         $this->SetXY($x+173, $y+2);
     $this->SetFont('Arial','',8);
     $this->Cell(22,10,$row2[18],1,1,'R',0,false);
