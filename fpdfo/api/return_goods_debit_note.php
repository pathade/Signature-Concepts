     ...
     $this->_out(sprintf('%.2F %.2F %.2F %.2F %.2F %.2F c ', $x1*$this->k, ($h-$y1)*$this->k,
        ...
        function Header()
        {
            ...
            $x = $this->GetX();
             ...
             $this->SetXY($x, $y+10);
            //  $this->Image('C:\Users\admin\Desktop\Work\LOGO-SIGNATURE_3.jpeg',48,21,10);
            ...
            $this->Cell(20,5,'Duplicate PDF',1,1,'L',false);
             ...
             $sql_charges = "SELECT srg. *,srg.id_pk ,ms.name,ms.gst_no,ms.add_date
             FROM supplier_return_good AS srg, mstr_supplier AS ms
             WHERE srg.id_pk = ms.supplier_id_fk ='$edit_id'";
            ...
            //  $y = $this->GetY();
             ...
             $this->Cell(72,5,$row['24'],0,1,'L',0,false);
             ...
             $this->SetFont('arial','',9);
             $this->Cell(30,5,$row['2'],0,1,'L',0,false);
             ...
             $this->SetFont('arial','',9);
             $this->Cell(60,5,$row['5'],0,1,'L',0,false);
             
             $this->SetXY($x+95, $y+33);
             $this->SetFont('arial','B',9);
             $this->Cell(16,5,'      Date  :',0,1,'L',0,false);

             $this->SetXY($x+113, $y+33);
             $this->SetFont('arial','',9);
             $this->Cell(20,5,$row['11'],0,1,'L',0,false);

             $this->SetXY($x+135, $y+33);
             $this->SetFont('arial','',9);
             $this->Cell(16,5,$row['19'],0,1,'L',0,false);

             $this->SetXY($x, $y+38);
             $this->SetFont('arial','B',9);
             $this->Cell(20,5,'Address    :',0,1,'L',0,false);

             $this->SetXY($x+20, $y+38);
             $this->SetFont('arial','',8);
             $this->Cell(70,5,$row['6'],0,1,'L',0,false);

            //  $this->SetXY($x+20, $y+43);
            //  $this->SetFont('arial','',8);
            //  $this->Cell(70,5,'MAHARASHTRA',0,1,'L',0,false);

             $this->SetXY($x+95, $y+38);
             $this->SetFont('arial','B',9);
             $this->Cell(16,5,'GRN No. :',0,1,'L',0,false);

             $this->SetXY($x+113, $y+38);
             $this->SetFont('arial','',9);
             $this->Cell(40,5,$row['4'],0,1,'L',0,false);
               
             $this->Line(8,67,166,67); //line
             ...
             $this->SetXY($x+85, $y+47);
             $this->SetFont('arial','B',9);
             $this->Cell(15,8,'Size',0,1,'C',0,false);

             $this->SetXY($x+111, $y+47);
             $this->SetFont('arial','B',9);
             $this->Cell(15,8,'Qty',0,1,'C',0,false);

             $this->SetXY($x+134, $y+47);
             $this->SetFont('arial','B',9);
             $this->Cell(15,8,'Rate',0,1,'C',0,false);


             $this->Line(8,75,166,75); //line

            //  $db = mysqli_connect("localhost","root","","nks");  
            //  $edit_id = 1;
             
            //  $sql_charges4 = "SELECT * FROM retail_return_goods_items AS rrgi
            //                            WHERE rrgi.return_item_id_pk = '$edit_id'";

            // $result_charges4 = mysqli_query($db, $sql_charges4);
            // $row3 = mysqli_fetch_row($result_charges4);
            ...
            // {       
             ...
             $this->SetXY($x-1, $y);
             $this->SetFont('arial','',9);
             $this->Cell(10,8,'1',0,1,'C',0,false);     //$row3['1']

             $this->SetXY($x+14, $y);
             $this->SetFont('arial','',9);
             $this->Cell(30,8,'Supplier Code --1',0,1,'L',0,false);
             ...
             $this->SetXY($x+85, $y);
             $this->SetFont('arial','',9);
             $this->Cell(15,8,'10',0,1,'C',0,false);

             $this->SetXY($x+111, $y);
             $this->SetFont('arial','',9);
             $this->Cell(15,8,'25',0,1,'C',0,false);
             
             $this->SetXY($x+134, $y);
             $this->SetFont('arial','',9);
             $this->Cell(15,8,'55',0,1,'C',0,false);               //

             $this->Line(8,90,166,90); //line

             $this->SetXY($x+111, $y+15);
             $this->SetFont('arial','B',9);
             $this->Cell(15,8,'25',0,1,'C',0,false);

             $this->SetXY($x+134, $y+15);
             $this->SetFont('arial','B',9);
             $this->Cell(15,8,'55',0,1,'C',0,false);            //
