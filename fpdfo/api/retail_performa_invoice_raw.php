...
// $id = $_GET['this_id'];
  ...
  function Header()
 {
    ...
    include('../../database/dbconnection.php');
     ...
     $this->Cell(200,28,'  ',0,1,'C',0,false);
...
$x = $this->GetX();
    ...
    while($row1 =mysqli_fetch_row($result_charges1))
    {
       ...
       $this->SetXY($x-5, $y);
            $this->SetFont('Arial','B',9);
            $this->Cell(10,6,$row1['0'],1,1,'C',0,false);
              ...
              $this->SetXY($x+5, $y+1);
               ...
               //        $this->Cell(17,12,' ',1,1,'L',0,false);
                      ...
                      $this->SetXY($x+61, $y);
                           $this->SetFont('Arial','',8);
                           $this->Cell(21,6,'0',1,1,'C',0,false);
   
                           $this->SetXY($x+82, $y);
                                $this->SetFont('Arial','',8);
                                $this->Cell(17,6,'0%',1,1,'C',0,false);
                                ...
                                $this->SetXY($x+97, $y+3);
                                     ...
                                     $this->SetFont('Arial','',8);
                                     $this->Cell(17,2,'BOX ',0,1,'R',0,false);
