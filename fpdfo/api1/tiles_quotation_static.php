...
// $id = $_GET['this_id'];
  ...
  function Header()
 {
    ...
    $this->SetXY($x, $y+7);
    $this->Image('../../app-assets/images/pdf/signature_2.jpg',8,22,20);
  ...
  $this->Ln(-3);
         ...
         $this->SetXY($x+10, $y+3);
         $this->SetFont('Arial','',8);
         $this->Cell(120,5,'ABC',0,1,'L',0,false); 
         ...
         $this->SetFont('Arial','',8);
         $this->Cell(30,5,'29-JAN-2021',0,1,'L',0,false);
         ...
         $this->SetXY($x+10, $y+8);
         $this->SetFont('Arial','',8);
         $this->Cell(118,5,'NEAR AAI MATA MANDIR, OPP SHREEJI LAWNS, BIBWEWADI, PUNE',1,1,'L',0,false);
         ...
         $this->SetFont('Arial','',8);
         $this->Cell(30,5,'ABSCDFD',0,1,'L',0,false);
         ...
         $this->SetFont('Arial','',8);
         $this->Cell(40,5,'+91 8977892212',0,1,'L',0,false);
         ...
         $this->SetFont('Arial','',8);
         $this->Cell(30,5,'8558272757',0,1,'L',0,false);
        ...
        //  $this->Cell(200,5,'',1,1,'L',0,false); 
         ...
         $this->Cell(10,10,'',1,1,'C',0,false);           //  1

         $this->SetXY($x+5, $y);
         $this->SetFont('Arial','',9);
         $this->Cell(50,10,'',1,1,'C',0,false); 

         $this->SetXY($x+55, $y);
         $this->SetFont('Arial','',9);
         $this->Cell(18,10,'',1,1,'C',0,false); 

         $this->SetXY($x+73, $y);
         $this->SetFont('Arial','',9);
         $this->Cell(13,10,'',1,1,'C',0,false); 
         ...
         $this->SetXY($x+101, $y);
         $this->SetFont('Arial','',9);
         $this->Cell(16,10,'',1,1,'C',0,false); 

         $this->SetXY($x+117, $y);
         $this->SetFont('Arial','',9);
         $this->Cell(12,10,'',1,1,'C',0,false);

         $this->SetXY($x+129, $y);
         $this->SetFont('Arial','',9);
         $this->Cell(14,10,'',1,1,'C',0,false);
         ...
         $this->SetXY($x+174, $y);
         $this->SetFont('Arial','',9);
         $this->Cell(21,10,'',1,1,'C',0,false);

         // -------------------

         $this->SetXY($x-5, $y+10);
         $this->SetFont('Arial','',9);
         $this->Cell(10,10,'',1,1,'C',0,false);           // 2

         $this->SetXY($x+5, $y+10);
         $this->SetFont('Arial','',9);
         $this->Cell(50,10,'',1,1,'C',0,false); 

         $this->SetXY($x+55, $y+10);
         $this->SetFont('Arial','',9);
         $this->Cell(18,10,'',1,1,'C',0,false); 

         $this->SetXY($x+73, $y+10);
         $this->SetFont('Arial','',9);
         $this->Cell(13,10,'',1,1,'C',0,false); 

         $this->SetXY($x+86, $y+10);
         $this->SetFont('Arial','',9);
         $this->Cell(15,10,'',1,1,'C',0,false); 

         $this->SetXY($x+101, $y+10);
         $this->SetFont('Arial','',9);
         $this->Cell(16,10,'',1,1,'C',0,false); 

         $this->SetXY($x+117, $y+10);
         $this->SetFont('Arial','',9);
         $this->Cell(12,10,'',1,1,'C',0,false);
         ...
         $this->SetXY($x-5, $y+20);
         $this->SetFont('Arial','',9);
         $this->Cell(10,10,'',1,1,'C',0,false);           //  3

         $this->SetXY($x+5, $y+20);
         $this->SetFont('Arial','',9);
         $this->Cell(50,10,'',1,1,'C',0,false); 

         $this->SetXY($x+55, $y+20);
         $this->SetFont('Arial','',9);
         $this->Cell(18,10,'',1,1,'C',0,false); 
         ...
         $this->SetXY($x+86, $y+20);
         $this->SetFont('Arial','',9);
         $this->Cell(15,10,'',1,1,'C',0,false); 

         $this->SetXY($x+101, $y+20);
         $this->SetFont('Arial','',9);
         $this->Cell(16,10,'',1,1,'C',0,false); 

         $this->SetXY($x+117, $y+20);
         $this->SetFont('Arial','',9);
         $this->Cell(12,10,'',1,1,'C',0,false);

         $this->SetXY($x+129, $y+20);
         $this->SetFont('Arial','',9);
         $this->Cell(14,10,'',1,1,'C',0,false);
         ...
         $this->SetXY($x+55, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(18,10,'',1,1,'C',0,false); 

         $this->SetXY($x+73, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(13,10,'',1,1,'C',0,false); 

         $this->SetXY($x+86, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(15,10,'',1,1,'C',0,false); 

         $this->SetXY($x+101, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(16,10,'',1,1,'C',0,false); 

         $this->SetXY($x+117, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(12,10,'',1,1,'C',0,false);

         $this->SetXY($x+129, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(14,10,'',1,1,'C',0,false);

         $this->SetXY($x+143, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(15,10,'',1,1,'C',0,false);

         $this->SetXY($x+158, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(16,10,'',1,1,'C',0,false);

         $this->SetXY($x+174, $y+30);
         $this->SetFont('Arial','',9);
         $this->Cell(21,10,'',1,1,'C',0,false);
         ...
         $this->SetXY($x-5, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(10,10,'',1,1,'C',0,false);           // 4

         $this->SetXY($x+5, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(50,10,'',1,1,'C',0,false); 

         $this->SetXY($x+55, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(18,10,'',1,1,'C',0,false); 

         $this->SetXY($x+73, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(13,10,'',1,1,'C',0,false); 

         $this->SetXY($x+86, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(15,10,'',1,1,'C',0,false); 

         $this->SetXY($x+101, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(16,10,'',1,1,'C',0,false); 

         $this->SetXY($x+117, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(12,10,'',1,1,'C',0,false);

         $this->SetXY($x+129, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(14,10,'',1,1,'C',0,false);

         $this->SetXY($x+143, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(15,10,'',1,1,'C',0,false);

         $this->SetXY($x+158, $y+40);
         $this->SetFont('Arial','',9);
         $this->Cell(16,10,'',1,1,'C',0,false);
...
$this->Ln(10);
    ...
    $this->SetXY($x+174, $y-10);
    $this->SetFont('Arial','B',9);
    $this->Cell(21,5,'0.0 ',1,1,'R',0,false); 
