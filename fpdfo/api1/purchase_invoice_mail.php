...
$get_email = "SELECT email FROM mstr_supplier ms,fin_purchase_invoice fpi WHERE fpi.id_pk='".$_GET['id']."' AND ms.supplier_id_fk=fpi.supplier_id_fk";
  ...
  $sql_charges="SELECT fpi.*, ms.supplier_id_fk, ms.name, ms.address, ms.phone_1
    ...
    $row=mysqli_fetch_row($result_charges);
            ...
            $x = $this->GetX();
                    ...
                    $this->Cell(10,0,'Purchase Invoice',0,1);
            ...
            //  $y = $this->GetY();
             ...
             $this->Cell(40,5,$row['37'],0,1,'L',0,false);
             ...
             $this->SetFont('arial','',9);
             $this->Cell(40,5,$row['39'],0,1,'L',0,false);
             ...
             $this->SetFont('arial','',8);
             $this->Cell(70,5,$row['38'],0,1,'L',0,false);
...
$total_qty = 0;
  $sql_charges2 ="SELECT *
  FROM fin_purchase_invoice_items
  WHERE fpi_id_fk = '$edit_id' ";
  ...
  {   
             ...
             $this->SetFont('arial','',9);
             $this->Cell(15,8,$row2['7'],0,1,'C',0,false);
            $total_qty += $row2['7'];
  }
