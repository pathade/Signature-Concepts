      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <!--<li class="nav-item"><a class="navbar-brand" href="index-2.html"><img class="brand-logo" alt="robust admin logo" src="../../app-assets/images/pdf/LOGO-SIGNATURE_3.jpeg">-->
            <?php
                if($flag==0)
                {
                    echo '<li class="nav-item"><a class="navbar-brand" href="index-2.html"><img class="brand-logo" alt="robust admin logo" src="../../app-assets/images/pdf/LOGO-SIGNATURE_3.jpeg">';
                    echo '<h5 class="brand-text">SIGNATURE CONCEPTS</h5></a></li>';
                }
                else if($flag==1)
                {
                    echo '<li class="nav-item"><a class="navbar-brand" href="index-2.html"><img class="brand-logo">';
                    echo '<h3 class="brand-text">SHREE</h3></a></li>';
                }
            ?>
            ...
            <ul class="nav navbar-nav float-right">         
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">Admin</span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a class="dropdown-item" data-toggle="modal" data-target="#myModal"><i class="ft-power"></i> Change Password</a>
                  <div class="dropdown-divider"></div><a class="dropdown-item" href="../item/logout.php"><i class="ft-power"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="container">
          ...
          <input type="password" class="input-lg form-control" name="old_password" id="old_password" placeholder="Old Password" >
          <!-- <input type="password" class="input-lg form-control mt-2" name="password1" id="password1" placeholder="New Password" autocomplete="off"> -->

          <input type="password" class="input-lg form-control mt-2" name="password2" id="password2" placeholder="New Password" autocomplete="off">
          </form>
          </div><!--/col-sm-6-->
          </div><!--/row-->
          </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary btn-load" data-dismiss="modal" onclick="submit_data1();" >Change Password</button>
        </div>
      </div>
...
//alert (old_pass + userpassword);
if (old_pass != userpassword ){ 
    $.ajax({
        url: '../../api/login/change_password.php',
        type: 'POST',
        data: { 'old_pass': old_pass, 'userpassword': userpassword },
        success: function (data) {
            ...
            if(data == "1")
            {
              $.toast({
                    heading: 'Success',
                    text: 'Password Updated Sussesfully',
