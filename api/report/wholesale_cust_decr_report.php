<?php
    ...
    // {
        ...
        $sql = "SELECT * FROM customer_manual_debit_credit WHERE cust_type='Wholesaler'";
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            $get_customer = "SELECT cust_name FROM tbl_wholesale_customer WHERE wc_id_pk='".$row['customer_id_fk']."'";
