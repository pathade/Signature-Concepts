<?php 
   ...
   // $emp_status="1";
    ...
    `transaction_date`='$transaction_date',`bank_id_fk` = '$account_no', `account_no`='$account_no',
    `cheque_no`= '$cheque_no', `cheque_date`='$cheque_date', `amount` = '$amount', `against_ref`= '$against_ref',
    `remark`='$remark',
