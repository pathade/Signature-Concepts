...
// $id = $_GET['this_id'];
  ...
  function Header()
 {
    ...
    $y = $this->GetY();
     ...
     $this->SetXY($x, $y+7);
     $this->Image('C:\Users\admin\Desktop\Work\signature_2.jpg',22,16,14);
    ...
    //  $x = $this->GetX();
     $this->SetXY($x-5, $y-50);
      ...
      $this->Cell(200,8,'Retail Invoice',0,1,'C',0,false);  //
     
     $this->SetXY($x-5, $y-29);
     $this->SetFont('Arial','B',14);
     $this->Cell(150,-15,'                               Signature Concepts LLP ',0,1,'L',0,false);
    
     $this->Ln();

     $y = $this->GetY();
     $x = $this->GetX();
     $this->SetXY($x+6, $y+24.5);
...
$x = $this->GetX();
     ...
     $this->Cell(120,10,' Customer :       MANJULA MALPANI',0,1,'L',0,false);
     ...
     $this->SetXY($x+15, $y+5);
     $this->SetFont('Arial','',8);
     $this->Cell(120,10,' 39, PARADISE SOL, BANER ROAD, OPP AXIS BANK, PUNE, 45 ',0,1,'L',0,false);
     ...
     $this->SetFont('Arial','',8);
     $this->Cell(120,7,'27ABXPM5040J1Z5',0,1,'L',0,false);
    ...
    //  $this->Cell(200,65,'  ',1,1,'C',0,false);
     ...
     $this->SetXY($x+5, $y+18);
     $this->SetFont('Arial','',8);
     $this->Cell(56,6,'1A420-Bevel White Matt-S1-4 INCH * ',0,1,'L',0,false);
     $this->SetXY($x+5, $y+23);
     $this->SetFont('Arial','',8);
     $this->Cell(56,4,'12 INCH ',0,1,'L',0,false);

      
$this->Ln(5);
     $y = $this->GetY();
     $x = $this->GetX();
     $this->SetXY($x+61, $y-23);
     $this->SetFont('Arial','B',9);
     ...
     $this->SetXY($x+61, $y-14);
     $this->SetFont('Arial','',9);
     $this->Cell(21,8,' 6907',0,1,'L',0,false);
     
    //  $y = $this->GetY();
    //  $x = $this->GetX();
     $this->SetXY($x+82, $y-23);
     $this->SetFont('Arial','B',9);
     $this->Cell(17,19,'  ',1,1,'C',0,false);  //

     $this->SetXY($x+82, $y-23);
     $this->SetFont('Arial','B',8);
     $this->Cell(17,8,'GST Rate',1,1,'C',0,false);
     $this->SetXY($x+82, $y-14);
     $this->SetFont('Arial','',8);
     $this->Cell(17,8,'18.00 ',0,1,'C',0,false);


     $this->SetXY($x+99, $y-23);
     $this->SetFont('Arial','B',9);
     $this->Cell(17,19,'  ',1,1,'C',0,false);        //
     $this->SetXY($x+99, $y-23);
     $this->SetFont('Arial','B',9);
     ...
     $this->SetFont('Arial','',8);
     $this->Cell(19,10,'1497.32 ',0,1,'R',0,false);

     $this->SetXY($x+135, $y-23);
     $this->SetFont('Arial','B',9);
     $this->Cell(29,19,'  ',1,1,'C',0,false);   //
     $this->SetXY($x+135, $y-23);
     $this->SetFont('Arial','B',9);
     $this->Cell(29,8,'Disc. %',1,1,'C',0,false);
     $this->SetXY($x+135, $y-15);
     $this->SetFont('Arial','',8);
     $this->Cell(29,10,'15.25',0,1,'C',0,false);

     $this->SetXY($x+164, $y-23);
     $this->SetFont('Arial','B',9);
     $this->Cell(31,19,'  ',1,1,'C',0,false);  //
     $this->SetXY($x+164, $y-23);
     $this->SetFont('Arial','B',9);
     $this->Cell(31,8,'Amount',1,1,'C',0,false);
     $this->SetXY($x+164, $y-15);
     $this->SetFont('Arial','',9);
     $this->Cell(31,10,'35530.00 ',0,1,'R',0,false);

     $this->SetXY($x-5, $y-4);
      $this->SetFont('Arial','B',9);
      $this->Cell(169,8,'',1,1,'R',0,false);
     ...
     $this->SetXY($x+164, $y-4);
     $this->SetFont('Arial','B',9);
     $this->Cell(31,8,'35530.00',1,1,'R',0,false);
     ...
     $this->SetFont('Arial','',9);
     $this->Cell(18,7,' 3197.70 ',1,1,'R',0,false);
     ...
     $this->SetFont('Arial','',9);
     $this->Cell(26,7,'35530.00 ',1,1,'R',0,false);
     ...
     $this->SetXY($x-3, $y+40);
     $this->SetFont('Arial','',9);
     $this->Cell(21.5,7,'6907',1,1,'C',0,false);
     $this->SetXY($x-3, $y+47);
     $this->SetFont('Arial','',9);
