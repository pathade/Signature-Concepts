     ...
     $this->_out(sprintf('%.2F %.2F %.2F %.2F %.2F %.2F c ', $x1*$this->k, ($h-$y1)*$this->k,
        ...
        function Header()
        {
          ...
          //   $db = mysqli_connect("192.168.0.101","stn","root","nks2");
            ...
            $sql_charges="SELECT * FROM mstr_retail_customer AS c, retail_receipt AS rr, retail_receipt_items AS rri 
            WHERE rr.id_pk = rri.receipt_id_fk AND 
            c.retail_cust_idpk = rr.cust_id_fk AND rr.id_pk='$edit_id'";
