        ...
        function Header()
        {
         ...
         //  $db = mysqli_connect("192.168.0.101","stn","root","nks2");
            ...
            $x = $this->GetX();
             ...
             //$this->Image('../../app-assets/images/pdf/LOGO-SIGNATURE_3.jpeg',49,20,10);
            ...
            $x = $this->GetX();
             ...
             $this->Line(8,46,166,46); //line
                    $this->SetXY($x+2, $y+18);
                    $this->SetFont('arial','B',11);
                    $this->Cell(148,5,'Quotation',0,1,'C',true);
          ...
          //   $db = mysqli_connect("192.168.0.101","stn","root","nks2");
            ...
            // $db = mysqli_connect("localhost","root","","nks2");
             ...
             $edit_id = $_GET['id'];
             $sql_charges = "SELECT *
                             FROM  retail_receipt AS rr, retail_receipt_items AS rri,mstr_retail_customer AS c
                             WHERE rr.id_pk  AND c.retail_cust_idpk = rr.cust_id_fk AND rri.receipt_id_fk  ='$edit_id'";
             ...
             $this->SetXY($x+45, $y+6);
             $this->SetFont('arial','',8);
             $this->Cell(10,0,'R/ '.$row['0'],0,'L',1,false);        // 
             ...
             $this->SetFont('arial','',8);
             $this->Cell(10,0,$row['13'],0,'L',1,false);
             ...
             $this->SetFont('arial','',8);
             $this->Cell(10,0,$row['39'].' ',0,'L',1,false);
             ...
             $this->SetFont('arial','',8);
             $this->Cell(15,0,$row['40'],0,'L',1,false);
             ...
             $this->SetFont('arial','',8);
            $this->Cell(55,5,convertNum($row['24']).' Only',0,1,'L',1,false);      //convertNum($row['20']).' Only'
          ...
          $this->Line(53,90,90,90); // line
             ...
             $this->SetFont('arial','',8);
             $this->Cell(10,0,$row['23'],0,'L',1,false);
             ...
             $this->SetFont('arial','',8);
             $this->Cell(10,0,$row['28'],0,'L',1,false);
             ...
             $this->SetFont('arial','',8);
             $this->Cell(10,0,$row['29'],0,'L',1,false);
             ...
             $this->SetFont('arial','B',8);
             $this->MultiCell(19,5,$row['24'],0,1,'R',0,false);
