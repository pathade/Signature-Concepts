  ...
  function Header()
 {
   ...
   // include('../../database/dbconnection.php');
    ...
    $row=mysqli_fetch_row($result_charges);
     ...
     $this->SetXY($x, $y+7);
     $this->Image('C:/Users/admin/Desktop/Work/LOGO-SIGNATURE_3.jpeg',35,18,15);
    ...
    if ($row1 != "")
    {
     ...
     $this->SetFont('Arial','',8);
     $this->Cell(115,5,$row1['24'],0,1,'L',0,false);           //        $row1['1']

     $this->SetXY($x+15, $y-7);
     $this->SetFont('Arial','',8);
     $this->Cell(115,5,$row1['47'],0,1,'L',0,false);             //      $row1['8']

     $this->SetXY($x+15, $y-2);
     $this->SetFont('Arial','',8);
     $this->Cell(115,5,$row1['48'],0,1,'L',0,false);

     $this->SetXY($x+15, $y+8);
     $this->SetFont('Arial','',8);
     $this->Cell(90,5,$row1['38'],0,1,'L',0,false);

     $this->SetXY($x+151, $y-12);
     $this->SetFont('Arial','',9);
     $this->Cell(40,5,$row1['3'],0,1,'L',0,false);

     $this->SetXY($x+151, $y-5);
     $this->SetFont('Arial','',9);
     $this->Cell(40,5,$row1['18'],0,1,'L',0,false);           // $row['18']
...
//  $this->Ln();
    ...
    // $this->Cell(17,12,'    ',1,1,'L',0,false);    ///              2
         ...
         $this->SetXY($x-5, $y);
         $this->SetFont('Arial','B',9);
         $this->Cell(10,9,$row2['1'],1,1,'C',0,false);             ///$row2['1']
          ...
          $this->Cell(56,9,'',1,1,'L',0,false);             //
                  ...
                  $this->SetXY($x+5, $y+1);
                  $this->SetFont('Arial','',9);
                  $this->Cell(56,4,$row2['20'],0,1,'L',0,false);             // $row2['20']
                  ...
                  //   $this->Cell(56,4,'fgdfgdf',0,1,'L',0,false);   
                        ...
                        $this->SetXY($x+61, $y);
                        $this->SetFont('Arial','',8);
                        $this->Cell(21,9,$row2['12'],1,1,'C',0,false);            //$row2['12']

                             $this->SetXY($x+82, $y);
                             $this->SetFont('Arial','',8);
                             $this->Cell(17,9,$row2['4'],1,1,'C',0,false);            // $row2['4']

                                  $this->SetXY($x+99, $y);
                                  $this->SetFont('Arial','',9);
                                  $this->Cell(17,9,$row2['3'],1,1,'C',0,false);        // $row2['3']

                                      $this->SetXY($x+116, $y);
                                      $this->SetFont('Arial','',8);
                                      $this->Cell(19,9,$row2['5'],1,1,'C',0,false);        //$row2['5']

                                        $this->SetXY($x+135, $y);
                                        $this->SetFont('Arial','',8);
                                        $this->Cell(30,9,$row2['6'],1,1,'C',0,false);           //$row2['6']

                                          $this->SetXY($x+165, $y);
                                          $this->SetFont('Arial','',9);
                                          $this->Cell(30,9,$row2['9'],1,1,'R',0,false);             //$row2['9']
                  //    }
    // $this->SetXY($x+5, $y);
    // $this->SetFont('Arial','',8);
    // $this->Cell(56,9,'',1,1,'L',0,false);    ///
   ...
   $this->Ln(-37);
      ...
      $this->SetXY($x+98, $y+37);
      $this->SetFont('Arial','B',9);
      $this->Cell(20,5,$row2['6'],0,1,'C',0,false);

      $this->SetXY($x+115, $y+37);
      $this->SetFont('Arial','B',9);
      $this->Cell(20,5,$row2['5'],0,1,'C',0,false);

      $this->SetXY($x+165, $y+37);
      $this->SetFont('Arial','B',9);
      $this->Cell(30,5,$row2['9'],1,1,'R',0,false);
