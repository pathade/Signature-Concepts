                                ...
                                <div class="row">
                                    ...
                                    ?>
			                        	<div class="form-group row">
				                        	...
				                        	<div class="col-md-3">
												<input type="text" id="order_no" class="form-control " name="order_no" readonly value="<?php echo date('y', strtotime('-1 year')).'-'.date('y').'/'.$res1[0] ?>" >
											</div>
                                                        ...
                                                        <!-- <table class="border-bottom-0 table table-hover table-responsive" id="tbl" > -->
                                                                    ...
                                                                    <tbody>
                                                                        <!-- <tr>
                                                                            ...
                                                                            <td><input type="text" id="quantity-0" value="1.00" onkeyup="get_quantity_value(this.id);" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';"/></td>
                                                                            <td><input type="text" id="sqrft-0" value="0.00" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                            <td><input type="text" id="rate-0" class="form-control" value="0.00" /></td>
                                                                            ...
                                                                            <td><input type="text" id="gst_per-0" value="18" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                            <td><input type="text" id="cgst-0" value="0.00" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                            <td><input type="text" id="sgst-0" value="0.00" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                            <td><input type="text" id="igst-0" value="0.00" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <input type="text" class="form-control" value="0" id="trans" name="trans">
                                                            </div>
                                                            <div class="col-md-1">
                                                                <label class="label-control" for="userinput1"><b>Load/Unload</b></label>
                                                                <input type="text" class="form-control" value="0" id="unload" name="unload">
                                                            </div>
                                                            <div class="col-md-2">
    ...
    <script>
        $(document).ready(function(){
            ...
            $.ajax(
            {
                ...
                url: "../../api/retail/add_retail_quotation.php",
                type: 'POST',
                data : {
