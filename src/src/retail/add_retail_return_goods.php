                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        ?>
				                        	...
				                        	<div class="col-md-3">
												<input type="text" id="return_no" class="form-control " value="<?php echo date('y',strtotime('-1 year')).'-'.date('y').'/'.$res_return_goods[0] ?>" name="return_no" readonly>
											</div>
                                    ...
                                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                ...
                                                <?php
                                                $get_customer_id = "SELECT customer FROM retail_proforma";
                                                $res_customer_id = mysqli_fetch_row(mysqli_query($db, $get_customer_id));

                                                $get_customer = "SELECT retail_cust_idpk, retail_cust_name FROM mstr_retail_customer WHERE retail_cust_idpk='$res_customer_id[0]'";
                                                $res_customer = mysqli_query($db, $get_customer) or die(mysqli_error($db));
