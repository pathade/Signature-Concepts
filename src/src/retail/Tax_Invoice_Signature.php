...
// $id = $_GET['this_id'];
  ...
  function Header()
 {
    ...
    $y = $this->GetY();
     ...
     $this->SetXY($x, $y+7);
     $this->Image('signature_2.jpg',26,21,21);
    ...
    //  $this->Cell(102,15,'Tax Invoice',0,1,'C',0,false);
     ...
     $this->Cell(120,10,' Customer :     RAKJESH MUNDRA',0,1,'L',0,false);

     $this->SetXY($x-5, $y+8);
     $this->SetFont('Arial','',8);
     $this->Cell(120,10,' Address     :     PUNE',0,1,'L',0,false);

     $this->SetXY($x+14, $y+12);
     $this->SetFont('Arial','',8);
     $this->Cell(120,10,' Ph.No.8806390552',0,1,'L',0,false);
     ...
     $this->SetXY($x+135, $y+2);
     $this->SetFont('Arial','B',9);
     $this->Cell(60,9,'  RI No.  : ',0,1,'L',0,false);

     $this->SetXY($x+155, $y+2);
     $this->SetFont('Arial','',9);
     $this->Cell(40,9,'20-21/240',0,1,'L',0,false);
     ...
     $this->SetFont('Arial','',9);
     $this->Cell(40,9,'29-December-2020',0,1,'L',0,false);
    ...
    //  $this->Cell(200,65,'  ',1,1,'C',0,false);
     ...
     $this->SetXY($x+5, $y+17);
     $this->SetFont('Arial','',8);
     $this->Cell(61,6,'1462 WC Connector PVC-1462 WC 3',0,1,'L',0,false);
     $this->SetXY($x+5, $y+23);
     $this->SetFont('Arial','',8);
     $this->Cell(61,4,' 450.00 1030.00 Connector PVC--',0,1,'L',0,false);

      

     $y = $this->GetY();
     $x = $this->GetX();
     $this->SetXY($x+66, $y-18);
     $this->SetFont('Arial','B',9);
     $this->Cell(21,18,'  ',1,1,'C',0,false);  //
     ...
     $this->SetFont('Arial','',9);
     $this->Cell(17,10,'3 pcs',0,1,'C',0,false);

     $this->SetXY($x+138, $y-17);
     $this->SetFont('Arial','B',9);
     $this->Cell(18,18,'  ',1,1,'C',0,false);
     $this->SetXY($x+138, $y-17);
     $this->SetFont('Arial','B',9);
     ...
     $this->SetXY($x+156, $y-17);
     $this->SetFont('Arial','B',9);
     $this->Cell(16,18,'  ',1,1,'C',0,false);
     $this->SetXY($x+156, $y-17);
     $this->SetFont('Arial','B',9);
     ...
     $this->SetXY($x+172, $y-17);
     $this->SetFont('Arial','B',9);
     $this->Cell(23,18,'  ',1,1,'C',0,false);  //
     $this->SetXY($x+172, $y-17);
     $this->SetFont('Arial','B',9);
     ...
     $this->Cell(23,10,'1030.00 ',0,1,'R',0,false);
      ...
      $y = $this->GetY();
     $x = $this->GetX();
     $this->SetXY($x-8.5, $y-91);
     $this->SetFont('Arial','B',11);
     $this->Cell(200,8,'Tax Invoice',0,1,'C',0,false);  //

     $this->SetXY($x-5, $y);
     $this->SetFont('Arial','B',9);
     $this->Cell(148,8,'Grand Total                      3        ',1,1,'R',0,false);
    ...
    //  $this->Cell(130,8,'        ',1,1,'R',0,false);
     ...
     $this->SetXY($x-5, $y+8);
     $this->SetFont('Arial','B',9);
     $this->Cell(148,48,' ',1,1,'R',0,false); //
     ...
     $this->SetXY($x-4, $y+19);
     $this->SetFont('Arial','B',9);
     $this->Cell(146,36,' ',1,1,'R',0,false);//
     $this->SetXY($x-4, $y+18);
     $this->SetFont('Arial','B',9);
     ...
     $this->SetFont('Arial','',9);
     $this->Cell(26,7,'1030.00',1,1,'C',0,false);
     ...
     $this->SetFont('Arial','B',9);
     $this->Cell(52,48,' ',1,1,'R',0,false);  //

     $this->SetXY($x+143, $y+8);
     $this->SetFont('Arial','B',9);
     $this->Cell(29,48,' ',1,1,'L',0,false);  //
     ...
     $this->SetXY($x+143, $y+15);
     $this->SetFont('Arial','B',9);
     $this->Cell(29,10,' Discount',0,1,'L',0,false);
     $this->SetXY($x+172, $y+15);
     $this->SetFont('Arial','B',9);
     $this->Cell(23,8,' 13.00 ',0,1,'R',0,false);
     ...
     $this->SetXY($x+172, $y+29);
     $this->SetFont('Arial','B',9);
     $this->Cell(23,8,' 183.06 ',0,1,'R',0,false);

     $this->SetXY($x+143, $y+38);
     $this->SetFont('Arial','B',9);
     $this->Cell(52,18,' ',1,1,'R',0,false);   //

     $this->SetXY($x+143, $y+39);
     $this->SetFont('Arial','B',10);
     $this->Cell(29,10,' Net Amount ',0,1,'L',0,false);
     $this->SetXY($x+172, $y+39);
     $this->SetFont('Arial','B',10);
     ...
     $this->SetXY($x-5, $y+7);
     $this->SetFont('Arial','B',9);
     $this->Cell(200,55,'  ',1,1,'C',0,false);   //  //
