	                ...
	                <div class="card-body">
	                    ...
	                    <form class="form form-horizontal" method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" id="pur_order_form1">
	                    	<div class="form-body">
                                <div class="row">
                                <?php
    $sql = "SELECT epo.*, me.expense_head , mv.saturation,mv.first_name,mv.last_name FROM exp_purchase_order epo, mstr_expense me, mstr_vendor mv WHERE Id='".$_GET['id']."' and epo.expense_head_id_fk = me.expense_idpk and epo.vendor_id_fk = mv.vendor_id_pk";
...
?>
                                    ...
                                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">PO Date </label>
				                        	<div class="col-md-9">
												<input type="date" class="form-control" value="<?php echo $row[2]; ?>" id="po_date" name="po_date" />
				                            </div>
				                        </div>
				                    </div>
                                    <div class="col-md-6">
				                        ...
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<select class="select2 form-control block" id="vendor_id_fk" class="select2" data-toggle="select2" name="vendor_id_fk">
                                                    <option value="<?php echo $row[4]; ?>" disabled selected><?php echo $row[22].". ".$row[23]." ".$row[24]; ?></option>
                                                    <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 mt-1">
                                                <label class="label-control" for="userinput1" >Amount</label>&nbsp;
                                            ...
                                            <div class="col-md-4 mt-1">
                                                <label class="label-control" for="userinput1" >Amt After Dis</label>
