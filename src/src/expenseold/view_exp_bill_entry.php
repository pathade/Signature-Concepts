                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                    $sql_charges="SELECT be.*, me.expense_idpk, me.expense_head, mv.vendor_id_pk, mv.saturation,mv.first_name,mv.last_name FROM exp_bill_entry be, mstr_expense me, mstr_vendor mv WHERE be.expense_head_id_fk = me.expense_idpk and be.vendor_id_fk= mv.vendor_id_pk";
                                ...
                                if($result_charges != "")
                                {
                                    ...
                                    <tr style="cursor: pointer">
                                        ...
                                        <td><?php echo  $row[34].". ".$row[35]." ".$row[36];?></td>
