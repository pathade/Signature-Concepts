		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Bank Master</h4>
                    <hr>
                                ...
                                <div class="row">
									<div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10 divcol">
                                            <input type="text" class="form-control"  placeholder="Account number" name="account_no" id="acc_no" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10 divcol">
                                                <textarea type="text" class="form-control"  placeholder="Bank Address" name="bank_address" id="bank_address"></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
			                        	<div class="form-group row">
											...
											<div class="col-md-9">
                                                <input type="text" class="form-control"  placeholder="0" name="ifsc_code" id="ifsc_code" />
                                                <!-- <div id="ifsc_error">
...
function submit_data()
{
    ...
    if(bank_name!="" && account_no!="" && bank_address!="" && phone_no1!="" && phone_no2!="" && ifsc_code!="" && expression.test(phone_no1) && expression.test(phone_no2))
    {
        $.ajax({
            url: '../../api/bank/save_bank.php',
            type: "POST",
            data: $('#form').serialize(),
            ...
            { 
                ...
                if(data == "1")
                {
                    ...
                    // // disable btn after inserting to avoid re-submission
