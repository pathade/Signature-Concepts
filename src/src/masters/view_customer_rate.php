                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-1 mobile-width">                                 
                                            <a href="add_customer_rate.php" style="float: left;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                    if($flag == 0) {
                                    $sql_charges="SELECT cr.*,wc.cust_name, i.final_product_code 
                                    FROM mstr_customer_rate cr, tbl_wholesale_customer wc, mstr_item i 
                                    where cr.item_id_fk = i.item_id_pk and cr.cust_id_fk = wc.wc_id_pk and cr.delete_status!='1' and i.flag='0' 
                                    and cr.flag='0' and wc.flag='0' ";
                                    }
                                    else {
                                    $sql_charges="SELECT cr.*,wc.cust_name, i.final_product_code 
                                    FROM mstr_customer_rate cr, tbl_wholesale_customer wc, mstr_item i 
                                    where cr.item_id_fk = i.item_id_pk and cr.cust_id_fk = wc.wc_id_pk and cr.delete_status!='1' and i.flag='1' 
                                    and cr.flag='1' and wc.flag='1' ";
                                    }
                                ...
                                if($result_charges != "")
                                {
                                    ...
                                    <tr style="cursor: pointer">
                                        ...
                                        <td style="display: flex;">
                                            <a href="edit_customer_rate.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                                  
                                            </a>
                                            
                                            <a href="../../api/customer/delete_customer_rate.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
