		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Upload Retail Customer Excel</h4>
                    <hr>
 ...
 $('#show').click(function(){
        ...
        function storeTblValues()
        {
            ...
            $('#exceltable tr').each(function(row, tr){
                ...
                var mail_id = $(tr).find('td:eq(5)').text();
                var ledger_bal = $(tr).find('td:eq(6)').text();
                var gno = $(tr).find('td:eq(7)').text();
            ...
            //alert("checkflag:"+check_flag);
                ...
                else if(check_flag == 1)
                {
                    ...
                    $.ajax(
                    {
                        url: "../../api/global/add_retail_customer_excel.php",
                        type: 'POST',
                        data : 
                        {
