		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">New Budget Master</h4>
                    <hr>
                                ...
                                <div class="row">
									<div class="col-md-6" style="display: none;">
				                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">Budget Id </label>
				                        	<div class="col-md-9">
												<input type="text" readonly class="form-control" value="<?php echo $_GET['id'] ?>" name="budget_id" class="">
				                            </div>
				                        </div>
				                    </div>
	                    			<div class="col-md-6">
									...
									<div class="col-md-6">
                                        ...
                                        <?php 
                                            ...
                                            $select_budget = "SELECT * FROM mstr_budget WHERE budget_idpk='".$_GET['id']."'";
                                            $row = mysqli_fetch_array(mysqli_query($db, $select_budget));
                                        ?>
			                        	...
			                        	<div class="form-group row">
											...
											<div class="col-md-9">
											    <select class="select2 form-control block" id="month" class="form-control " placeholder="" name="month" >
													<option value="<?php echo $row['for_month'] ?>"><?php echo $row['for_month'] ?></option>
									...
									<div class="col-md-6">
			                        	<div class="form-group row">
											...
											<div class="col-md-9">
                                                <input type="number" id="amt_per_month" class="form-control " placeholder="" name="amt_per_month" min=0 required value="<?php echo $row['amt_per_month'] ?>"/>
									...
									<div class="col-md-12">
										<div class="form-group row">
				                        	...
				                        	<div class="col-md-10 divcol">
												<input type="text" class="form-control"  placeholder="" name="remark" id="remark" required value="<?php echo $row['remark'] ?>">
												<div id="remark_error">
...
<script>
	function save_data()
	{
		...
		if((exphead != "" || exphead.length > 0) && (amt_per_month != "" || amt_per_month.length > 0) && (remark != "" || remark.length > 0))
		{
			...
			$.ajax({
				url: '../../api/budget/edit_budget.php',
				type: "POST",
				// data: {
				// 	branch: branch,
				// 	exphead: exphead,
