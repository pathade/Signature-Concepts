                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                    if ($flag == 0) {
                                        $sql_charges="SELECT DISTINCT * FROM exp_purchase_order where flag = '0'";
                                    }
                                    else {
                                    $sql_charges="SELECT DISTINCT * FROM exp_purchase_order where flag = '1'";
                                    }
                                ...
                                if($result_charges != "")
                                {
                                    ...
                                    <tr style="cursor: pointer;background-color: mistyrose;">
                                        ...
                                        <?php 
                                         if ($flag == 0) {
                                        $sql1 = "SELECT DISTINCT expense_idpk, expense_head FROM mstr_expense WHERE expense_idpk = $row[3] and flag = '0'";
                                         }
                                         else {
                                            $sql1 = "SELECT DISTINCT expense_idpk, expense_head FROM mstr_expense WHERE expense_idpk = $row[3] and flag = '1'";
                                         }
                                        ...
                                        if ($flag == 0) {
                                        $sql2 = "SELECT DISTINCT vendor_id_pk, saturation, first_name, last_name FROM mstr_vendor WHERE vendor_id_pk = $row[4] and flag='0'";
                                        }
                                        else {
                                            $sql2 = "SELECT DISTINCT vendor_id_pk, saturation, first_name, last_name FROM mstr_vendor WHERE vendor_id_pk = $row[4] and flag='1'";
                                        }
