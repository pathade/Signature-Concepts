                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                    if($flag ==0){
                                    $sql_charges="SELECT DISTINCT * FROM exp_pay_advice where flag='0' ";
                                    }
                                    else {
                                        $sql_charges="SELECT DISTINCT * FROM exp_pay_advice where flag='1' ";
                                    }
                                            ...
                                            ?>
                                                <tr style="cursor: pointer;    background-color: mistyrose;">
                                                    ...
                                                    <td style="display: flex;">
                                                        <a href="edit_payment_advice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                            ...
                                            ?>
                                                <tr style="cursor: pointer">
                                                    ...
                                                    <td style="display: flex;">
                                                        ...
                                                        <a onclick="return confirm('Are you want to delete?')" href="../../api/expense/delete_payment_advice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
                                                            <i class="fa fa-trash" aria-hidden="true"></i>
                                                        </a>
                                                    </td>
                                                    <td><?php echo $row[0]; ?> </td>
