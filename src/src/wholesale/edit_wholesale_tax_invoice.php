...
<?php 
    ...
    echo $sql = "SELECT * FROM wholesale_tax_invoice WHERE tax_id_pk='$edit'";
    $sql = "SELECT *,work_no FROM `wholesale_tax_invoice` 
    as ti ,wholesale_work_order as wo where ti.work_id_fk = wo.work_order_id AND tax_id_pk='$edit'";
    
    $resd = mysqli_query($db,$sql);
    while($row = mysqli_fetch_array($resd))
    {
        $cust_id_fk = $row['cust_id_fk'];

        $sql1 = "SELECT * FROM tbl_wholesale_customer WHERE wc_id_pk='$cust_id_fk'";
        $sql1res = mysqli_query($db,$sql1);
        while($srow = mysqli_fetch_array($sql1res))
        {
            $cust_name = $srow['cust_name'];
            
        }

        $sql1 = "SELECT * FROM tbl_wholesale_customer_site_details WHERE wc_id_fk='$cust_id_fk'";
        $sql1res = mysqli_query($db,$sql1);
        while($srow = mysqli_fetch_array($sql1res))
        {
        ...
        $f1 = "SELECT distinct dc_id_fk FROM `wholesale_tax_invoice_items` WHERE tax_id_fk='$edit'";
        $frres1 = mysqli_query($db,$f1) or die(mysqli_error($db));
        while($kl1 = mysqli_fetch_array($frres1))
        {
            $dc_no = $kl1['dc_id_fk'];

            
            $f1 = "SELECT distinct t_id_fk,v_id_fk FROM `wholesale_delivery_challan` WHERE wd_ch_id_pk='$dc_no'";
            $frres1 = mysqli_query($db,$f1);
            while($kl1 = mysqli_fetch_array($frres1))
            {
                $t_id_fk = $kl1['t_id_fk'];
                $v_id_fk = $kl1['v_id_fk'];
            ...
            $f1 = "SELECT distinct v_no FROM `mstr_transporter_vehicle` WHERE tv_id_pk='$v_id_fk'";
            $frres1 = mysqli_query($db,$f1);
            while($kl1 = mysqli_fetch_array($frres1))
            {
                $ve_v_no = $kl1['v_no'];
            ...
            $f1 = "SELECT distinct name FROM `mstr_transporter` WHERE t_id_pk='$t_id_fk'";
            $frres1 = mysqli_query($db,$f1);
            while($kl1 = mysqli_fetch_array($frres1))
            {
                $transname = $kl1['name'];
		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Wholesale Tax Invoice</h4>
                    <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput1">SO Id</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="work_no_select" value="<?php echo $row['work_no'];?>" class="form-control " placeholder="0" name="wo_id">
                                                        <!-- <select id="work_no_select" name="work_no_select" class="form-control"> 
                                                            <option></option>
                                                        </select> -->
                                                        <input type="hidden" id="work_no_select_hidden" name="work_no_select_hidden" value="<?php echo $row['work_id_fk'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="tax_inv_no" class="form-control " placeholder="0" name="tax_inv_no" value="<?php echo $row['Tax_inv_no'];?>" readonly="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="bill_date" class="form-control " name="bill_date" value="<?php echo $row['bill_date'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="site" class="form-control " value="<?php echo $site_name;?>" name="site" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="vehicle_no" class="form-control " name="vehicle_no" readonly value="<?php echo $ve_v_no;?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="transporter" class="form-control " value="<?php echo $transname;?>" name="transporter" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" id="billing_name" class="form-control " name="billing_name" value="<?php echo $row['billing_name'];?>" >
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select class="select2 form-control block" id="customer" class="select2" data-toggle="select2" name="customer" onChange="customer_select(this.id);">
                                                    <option value="<?php echo $row['cust_id_fk'];?>" disabled selected><?php echo $cust_name;?></option>
                                                    <?php
                                        ...
                                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                <div id="dc_no" class="dc_box" name="dc_no" >
                                                        <?php 
                                                            $f = "SELECT distinct dc_id_fk FROM `wholesale_tax_invoice_items` WHERE tax_id_fk='$edit'";
                                                            $frres = mysqli_query($db,$f) or die(mysqli_error($db));
                                                            while($kl = mysqli_fetch_array($frres))
                                                            {
                                                                $dc_no = $kl['dc_id_fk'];

                                                                
                                                                $f = "SELECT distinct challan_no,wd_ch_id_pk FROM `wholesale_delivery_challan` WHERE wd_ch_id_pk='$dc_no'";
                                                                $frres = mysqli_query($db,$f);
                                                                while($kl = mysqli_fetch_array($frres))
                                                                {
                                                                    $challan_no = $kl['challan_no'];
                                                                    $wd_ch_id_pk = $kl['wd_ch_id_pk'];

                                                                    //wholesale_delivery_challan
                                                               
                                                        
                                                        ?>
                                                        <!-- <input type="checkbox" id="tax_inv_no1" name="tax_inv_no1">&nbsp;  -->
                                                        <input type="checkbox" id="dc-0" name="dc" onchange="doalert(this.id)" value="<?php echo $wd_ch_id_pk;?>" checked> &nbsp;<?php echo $challan_no;?>
                                                        <?php  }
                                                            } ?>
                                                </div>
...
$(document).ready(function()
{
    table = $('#tbl').DataTable( { 
            ...
            ajax: 
            {
                "url": "../../api/wholesale/fetch_tax_invoice_items_for_update.php",
                "type": "POST",
                data : 
                {
                    'tax_id' : <?php echo $edit;?>
                },
                // dataType: 'text',
    ...
    $(document).ready(function(){
        ...
        && gross_amt!="" && tax_amt!="" && net_amt!="0" )
        {
            ...
            $.ajax(
            {
                ...
                url: "../../api/wholesale/update_wholesale_tax_invoice.php",
                type: 'POST',
                data : $('#form1').serialize() + "&newRawItemArray=" + newRawItemArray 
                +"&edit=" + <?php echo $_GET['id'];?> + '&customer='+customer,
                dataType:'text',  
                success: function(data)
                { 
                    console.log(data);
                    if(data == "1")
                    {
                        $.toast({
                            heading: 'Success',
                            text: 'Wholesale Tax Invoice Updated',
