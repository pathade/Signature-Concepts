...
<form method="post" id="cust_advance_form" action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>">
	<div class="row">
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Add Customer Advance</h4>
                    <hr>
	                ...
	                <div class="card-body">
	                    ...
	                    <form class="form form-horizontal" id="form" data-toggle="validator" role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<select class="form-control" id="pay_mode" name="pay_mode" onchange="paymode_select();">
                                    ...
                                    <div class="col-md-6 d-none">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<!-- <select class="form-control" id="manual_debit_no" name="manual_debit_no" >
                                                    <option value="" >Select</option>
												</select> -->
                                                <input type="text" id="manual_debit_no" name="manual_debit_no" class="form-control" value="0">
				                            </div>
				                        </div>
				                    </div>
                                    <div class="col-md-6 d-none">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<input type="number" id="manual_debit_amt" class="form-control " value="0" name="manual_debit_amt" />
											</div>
				                        </div>
				                    </div>
                                    <div class="col-md-6" id="bank_name_row">
				                        	...
				                        	<div class="col-md-9">
												<select class="select2 form-control block" id="bank_name" class="select2" onchange="getAccountNo()" data-toggle="select2" name="bank_name">
                                                    <?php
                                                        ...
                                                        echo $option;
                                                        $sql =  "SELECT bank_idpk,bank_name  FROM mstr_bank order by bank_name asc";  // Use select query here 
                                                        $result = mysqli_query($db, $sql);
                                    ...
                                    <div class="col-md-6" id="bank_no_row">
			                        	<div class="form-group row">
                                        <label class="col-md-3 label-control" for="userinput1">Account No <span style="color:red;"> *</span></label>
											<div class="col-md-9">
												<select class="select2 form-control block" id="account_no" class="select2" data-toggle="select2" name="account_no" data-placeholder="Select Account No" onchange="acc_click();" >
                                                <!-- -->
                                                </select>
                                    ...
                                    <div class="col-md-6" id="chno_row">
			                        	<div class="form-group row">
                                    ...
                                    <div class="col-md-6" id="chdate_row">
			                        	<div class="form-group row">
                                            <label class="col-md-3 label-control" for="userinput1">Cheque Date</label>
				                        	<div class="col-md-9">
                                                <input type="date" id="cheque_date" class="form-control " placeholder="" name="cheque_date" value="<?php echo date('Y-m-d'); ?>">
                                            </div>
			                       		</div>
                                    </div>
                                    <div class="col-md-6">
	                        ...
	                        <div class="form-actions right">
								...
								<button type="button" onclick="save_data();" name="add_purchase_order" class="btn btn-primary" id="add_delete_pending_qua" >
...
$(document).ready(function()
{
  //hide all error span
    ...
    // document.getElementById("bank_name_row").style.display = "none";
    // document.getElementById("bank_no_row").style.display = "none";
    // document.getElementById("chno_row").style.display = "none";
    // document.getElementById("chdate_row").style.display = "none";
 ...
 // console.log (name + cheque_date);
    if(customer!="")
    {
        if(pay_mode!="")
        {
            if(pay_mode == "Cash")
            {
                if(amount != "")
                {
                    $.ajax( 
                    {
                        ...
                        url: "../../api/wholesale/save_wholesale_cust_advance.php",
                        type: 'POST',
                        data : $('#cust_advance_form').serialize()+'&account_no='+account_no+'&branch='+branch,
                        dataType:'text',  
                        success: function(data) 
                        { 
                            ...
                            if(data == "1")
                            {
                                ...
                                setTimeout(() => 
                                {
                                    window.location.href="view_customer_advance.php";    
                                }, 5000);
            ...
            {
                if(amount!="" && bank_name!="" && account_no!="" && cheque_date!="" && cheque_no!="")
                {
                    //ajax call
                    $.ajax(
                    {
...
<script>
    function paymode_select()
    {
        var pay = document.getElementById("pay_mode").value;
        if(pay == "Cheque")
        {   
            document.getElementById("bank_name_row").style.display = "block";
            document.getElementById("bank_no_row").style.display = "block";
            document.getElementById("chno_row").style.display = "block";
            document.getElementById("chdate_row").style.display = "block";
        }
        else
        {
            document.getElementById("bank_name_row").style.display = "none";
