...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/retail_pending_report.php',
            type: 'POST',
            data: {
            },
            dataType: 'json',
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var item=`<p>${data[index].item_name}</p>`;
                    var oqty=`<p>${data[index].oqty}</p>`;
                    var pqty=`<p>${data[index].pqty}</p>`;
