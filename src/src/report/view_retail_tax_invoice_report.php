...
var table = "";
  ...
  extend: 'pdfHtml5',
  title: ' Retail Tax Invoice Report',
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/retail_tax_invoice_report.php',
            type: 'POST',
            data: {
            ...
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var transporter=`<p>${data[index].transporter}</p>`;
                    var vehicle=`<p>${data[index].vehicle}</p>`;
