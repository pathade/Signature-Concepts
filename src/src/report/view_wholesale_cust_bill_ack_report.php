                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <div class="col-md-9">
                                                            <input class="checkbox" type="radio" id="wholesale" name="type" checked />&nbsp;Wholesale &nbsp;&nbsp;
                                                            <input class="checkbox" type="radio" id="retail" name="type" />&nbsp;Retail
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
