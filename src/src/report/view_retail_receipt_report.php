...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/retail_receipt_report.php',
            type: 'POST',
            data: {
            ...
            success: function(data){
                ...
                {
                    var select = '';
                    var id=`<p>${data[index].receipt_no}</p>`;
                    ...
                    var mdr=`<p>${data[index].mdr}</p>`;
                    var mcr=`<p>${data[index].mcr}</p>`;
                    var total_disc=`<p>${data[index].total_disc}</p>`;
                    // var tax_amt=`<p>${data[index].tax_amt}</p>`;
