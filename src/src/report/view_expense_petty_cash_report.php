                                            ...
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label class="col-md-3 label-control" for="userinput1"></label>
                                                        <div class="col-md-9">
                                                            <input class="checkbox" type="checkbox" id="receipts" name="receipts" />&nbsp;Receipts &nbsp;&nbsp;
                                                            <input class="checkbox" type="checkbox" id="payments" name="payments" />&nbsp;Payments
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/expense_petty_cash_report.php',
            type: 'POST',
            data: {
            ...
            success: function(data){
                ...
                {
                    var select = '';
                    var exp=`<p>${data[index].exp}</p>`;
                    var date=`<p>${data[index].date}</p>`;
                    var to=`<p>${data[index].to}</p>`;
                    var amt=`<p>${data[index].amount}</p>`;
                    var emp=`<p>${data[index].emp}</p>`;
                    var pby=`<p>${data[index].prepared_by}</p>`;
