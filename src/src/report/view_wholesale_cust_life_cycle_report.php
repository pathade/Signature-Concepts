        ...
        <div class="content-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <div class="col-md-9">
                                                            <input class="checkbox" type="radio" id="wholesale" name="type1" value="1" checked />&nbsp;Wholesale &nbsp;&nbsp;
                                                            <input class="checkbox" type="radio" id="retail" name="type1" value="0" />&nbsp;Retail
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">
                        <div class="table-responsive" id="tblwholesale">
                        ...
                        <!-- <div class="table-responsive" id="tblretail">
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/customer_life_cycle_report.php',
            type: 'POST',
            data: {
            ...
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var sono=`<p>${data[index].sono}</p>`;
                    var so_date=`<p>${data[index].so_date}</p>`;
                    var dc_no=`<p>${data[index].dc_no}</p>`;
                    var dc_date=`<p>${data[index].dc_date}</p>`;
                    var invno=`<p>${data[index].invno}</p>`;
                    var inv_date=`<p>${data[index].inv_date}</p>`;
