                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
			                        	...
			                        	<div class="form-group row">
				                        	...
				                        	<div class="col-md-3">
												<input type="text" id="return_no" readonly class="form-control " name="return_no" value="<?php echo date('y', strtotime('-1 year')).'-'.date('y').'/'.$return_no_res['sr_no']; ?>" />
											</div>
                                ...
                                <div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                            <select class="select2 form-control block" id="supplier" class="select2" data-toggle="select2" name="supplier" onchange="getGRNNo()">
                                                <option value="" disabled selected>Select Supplier </option>
                                                <?php

                                                    $sql = "SELECT DISTINCT supplier_id_fk FROM fin_purchase_invoice WHERE status!='1'";
                                    ...
                                    <div class="col-md-6">
			                        	<div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                <select class="select2 form-control block" id="grn_no" class="select2" data-toggle="select2" name="grn_no" onchange="getGrnDetails();">
                                ...
                                <div class="row">
				                    ...
				                    <div class="col-md-6">
                                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                <input type="text" class="form-control" readonly placeholder="Mobile No" name="mobile_no" id="mobile_no" />
                                                <!-- <div id="mobile_error">
			                        	...
			                        	<div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                <select class="select2 form-control block" id="prepared_by" class="select2" data-toggle="select2" name="prepared_by">
                                                        <option value="" disabled selected>Select Prepared By </option>
                                                        <?php
...
{   
    ...
    document.getElementById('grn_no').innerHTML = null;
