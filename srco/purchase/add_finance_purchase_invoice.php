                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    ?>
                                                    <div class="col-md-9">
                                                    <input class="form-control" readonly id="fin_yr" name="fin_yr" value="<?php echo $year ?>" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                    <input type="text" id="pi_no" class="form-control " placeholder="" name="pi_no" readonly value="<?php echo date('y', strtotime('-1 year')).'-'.date('y').'/'.$row['2']; ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <select class="select2 form-control block" id="supplier" class="select2" data-toggle="select2" name="supplier" onchange="getGrnNo(this.value)">
                                                        ...
                                                        <?php
                                                            ...
                                                            $sql = "SELECT DISTINCT supplier FROM grn";
                                                            $result = mysqli_query($db,$sql);
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput1">Bill No <span style="color:red;"> *</span></label>
                                                    <div class="col-md-9">
...
<script>
        ...
        $('#add_purchase_invoice').on('click', function(){
           ...
           // alert (supplier);
            ...
            {
                $.ajax({
                    url: '../../api/purchase/add_fin_purchase_invoice.php',
                    type: 'POST',
                    data : {
                    ...
                    { 
                        ...
                        if(data == "1")
                        {
                            $.toast({
                            heading: 'Success',
                            text: 'Purchase Invoice Added Sussesfully',
                ...
                $.toast({
                                heading: 'Error',
                                text: 'Please enter Supplier and Bill No...!!',
                                showHideTransition: 'slide',
                                position: 'top-right',
                                hideAfter: 5000,
                                icon: 'error'
            ...
            if(grn[i].checked)
            {
                ...
                $.ajax({
                    ...
                    $.each(data, function(index) 
                    {
                        ...
                        var process_amount= `<input type="text" class="form-control d-none" id="process_amt-${cnt}" value="${data[index].process_amount}" />`;
                        ...
                        var tax= `<input type="text" class="form-control d-none" id="tax-${cnt}" value="${data[index].tax}" />`;
                        var tax_amt= `<input type="text" class="form-control d-none" id="tax_amt-${cnt}" value="${data[index].tax_amt}" />`;
                        var net_amt= `<input type="text" class="form-control" readonly id="net_amt-${cnt}" value="${data[index].net_amt}" />`;
                        var trans_oct= `<input type="text" class="form-control d-none" id="trans_oct-${cnt}" value="${data[index].trans_oct}" />`;
                        var italian_sqfit= `<input type="text" class="form-control d-none" id="italian_sqfit-${cnt}" value="${data[index].italian_sqfit}" />`;
                        var italian_slide= `<input type="text" class="form-control d-none" id="italian_slide-${cnt}" value="" />`;
