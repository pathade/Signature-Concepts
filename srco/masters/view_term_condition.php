                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-2 col-sm-2 mobile-width">                                  
                                        <a href="add_term_condition.php" style="float: right;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="border-bottom-0 table table-hover table-bordered table-striped responsive" id="tbl">
                                ...
                                <?php
                                    $sql_charges="SELECT * FROM mstr_term_condition ";
                                ...
                                if($result_charges != "")
                                    ...
                                    <tr style="cursor: pointer">
                                        ...
                                        <td style="display: flex;">
                                            <a href="edit_term_condition.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                                  
                                            </a>
                                            <a onclick="return confirm('Are you want to delete?')" href="../../api/term&condition/delete_term_condition.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
                                        ...
                                        <td ><?php if( $row[4] == 1){?><span class="green-text"><?php echo "Active";?></span><?php }else{?><span class="text-danger"><?php echo "Inactive";?></span><?php } ?></td>
