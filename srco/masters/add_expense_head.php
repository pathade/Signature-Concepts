		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Expense</h4>
                    <hr>
                                ...
                                <div class="row">
									...
									<div class="col-md-12">
			                        	<div class="form-group row">
											...
											<div class="col-md-6">
                                                <input type="text" id="expname" class="form-control " placeholder="" name="expname" />
									...
									<div class="col-md-12">
			                        	<div class="form-group row">
											...
											<div class="col-md-6">
											    <input type="text" id="expdescription" class="form-control " placeholder="" name="expdescription" />
...
//   document.getElementById("expdesc_error").style.display = "none"; $('#form').serialize()
  ///////////////////////////
});
</script>
<script>
		...
		if((exphead != "" || exphead.length > 0) && (expname != "" || expname.length > 0) && (expdescription != "" || expdescription.length > 0))
		{
          //  alert('inside');
			...
			$.ajax({
				...
				type: "POST",
				url: '../../api/expense/save_expense_head.php',
				data: "&exphead=" + exphead + '&expname='+ expname + '&expdescription=' + expdescription,
				success: function(data)
				{
					...
					if(data == "1")
					{
						...
						// disable button after inserting to aviod re-submission
