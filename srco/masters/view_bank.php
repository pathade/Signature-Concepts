                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-2 col-sm-2 mobile-width">                                 
                                            <a href="add_bank.php" style="float: left;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                                    </div>
                            ...
                            <div class="card-body" style="padding: 1.5rem;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10">
                                        ...
                                        <input type="radio" name="exp_head" id="Active" style="height: calc(2.75rem + -22px);width: 20px" />&nbsp;Active &nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="exp_name" id="InActive" style="height: calc(2.75rem + -22px);width: 20px" />&nbsp;InActive 
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                    if ($flag == 0) {
                                    $sql_charges="SELECT * FROM mstr_bank where flag='$flag'"; 
                                    }
                                    else {
                                        $sql_charges="SELECT * FROM mstr_bank where flag='1' "; 
                                    }
                                ...
                                if($result_charges != "")
                                {
                                    ...
                                    <tr style="cursor: pointer">
                                        ...
                                        <td style="display: flex;">
                                            <a href="edit_bank.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                                  
                                            </a>
                                            <a onclick="return confirm('Are you sure you want to delete?')" href="../../api/bank/delete_bank.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
