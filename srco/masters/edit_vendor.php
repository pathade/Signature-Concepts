...
<?php 
    ...
    $edit_id = $_GET['id'];
    $sql_charges="SELECT * FROM mstr_vendor where vendor_id_pk='$edit_id'";
		...
		<div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Edit Vendor</h4>
                    <hr>
	                    ...
	                    <form class="form form-horizontal" id="form">
                            ...
                            <div class="col-md-6">
                              ...
                              <label class="col-md-2 label-control" for="userinput1">Company Name<span style="color:red;"> *</span></label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control " value="<?php echo $row[4];?>" placeholder="Company Name" name="company_name" id="company_name" onkeyup="written(this.id);">
		                        ...
		                        <div class="row">
		                        	<div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                          <input type="text" value="<?php echo $row[2];?>" class="form-control " placeholder="Name" name="first_name" id="first_name" onkeyup="written(this.id);">
                                          <span id="fname_error" style="color:red;"></span>
                                        </div>

                                        <label class="col-md-1 label-control" for="userinput1" >GSTIN </label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control "  value="<?php echo $row[35];?>" placeholder="GST" name="gstin" id="gstin" onkeyup="written(this.id);">
                                        
                                        </div>
                                                

                                                <!-- <label class="col-md-1 label-control" for="userinput1">Type <span style="color:red;"> *</span></label>
                                                <div class="col-md-4">
                                                <select class="select2 form-control block" name="type" id="type" class="select2" data-toggle="select2" >
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control " placeholder="Party" value="<?php echo $row[36];?>" name="party_name" id="party_name" onkeyup="written(this.id);">
                                                    <span id="cname_error" style="color:red;"></span>
                                                </div> -->
			                       	          </div>
                                        ...
                                        <!-- <div class="form-group row">
                                            <label class="col-md-2 label-control" for="userinput1">Vendor Display Name<span style="color:red;"> *</span></label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control " value="<?php echo $row[6];?>" placeholder="Company Display Name" name="Company_display_name" id="Company_display_name" onkeyup="written(this.id);">
                                                    <span id="cdname_error" style="color:red;"></span>
                                                </div>
                                                <label class="col-md-1 label-control" for="userinput1">PAN No<span style="color:red;">*</span> </label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control " placeholder="PAN No" value="<?php echo $row[37];?>" name="pan_no" id="pan_no" onkeyup="written(this.id);">
                                                    <span id="cmob_error" style="color:red;"></span>
                                                </div>
			                       		        </div> -->
                                        <div class="form-group row">
                                            <label class="col-md-2 label-control" for="userinput1">Email</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control " value="<?php echo $row[6];?>" placeholder="vendor Email" name="Customer_email" id="Customer_email" onkeyup="written(this.id);">
                                                  
                                                </div>
                                               
			                       		        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 label-control" for="userinput1">Phone </label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control " value="<?php echo $row[7];?>" placeholder="Work Phone" name="Customer_work_phone" id="Customer_work_phone" onkeyup="written(this.id);">
                                                
                                                </div>

                                                <label class="col-md-1 label-control" for="userinput1">Mobile </label>
                                              <div class="col-md-4">
                                                <input type="number" class="form-control " value="<?php echo $row[8];?>" placeholder="Mobile" name="Customer_mobile" id="Customer_mobile" onkeyup="written(this.id);">
																...
																<div class="col-md-6">
																	...
																	<div class="form-group row">
																		<label class="col-md-3 label-control" for="userinput1">Opening Balance</label>
																			<div class="col-md-9">
																				<input type="text" value="<?php echo $row[11];?>" class="form-control " placeholder="Opening Balance" value="0" name="Customer_opening_balance" id="Customer_opening_balance">
                                        <span id="bal_error" style="color:red;"></span>
																	...
																	<div class="form-group row">
																		<label class="col-md-3 label-control" for="userinput1">Payment Terms</label>
																			<div class="col-md-9">
																				<input type="text" value="<?php echo $row[12];?>" class="form-control " placeholder="Payment Terms" name="payment_terms" id="payment_terms">
          ...
          <!-- Left Details-->
            <div class="col-lg-6 mt-1">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="<?php echo $row[13];?>" class="form-control" name="txtCustomerBillingAddressLine1" id="txtCustomerBillingAddressLine1" onkeyup="written(this.id);" placeholder="Address Line 1"  >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<?php echo $row[14];?>" name="txtCustomerBillingAddressLine2" id="txtCustomerBillingAddressLine2" onkeyup="written(this.id);" placeholder="Address Line 2" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="<?php echo $row[15];?>" class="form-control" name="txtCustomerBillingAddressLine3" id="txtCustomerBillingAddressLine3" placeholder="Address Line 3" >
                  ...
                  <label  class="col-lg-4 col-form-label" >Country</label>
                    <div class="col-lg-8">
					  ...
					  <select class=" form-control block" id="comboBillingCountry" name="comboBillingCountry"  onchange="getStates()" >
						...
						<?php
                        $sql = "select * from mstr_country where id='$row[16]' and id!=101 order by id asc";
                        $result = mysqli_query($db, $sql);
                        while($row1 = mysqli_fetch_array($result))
                        {
                          ...
                          echo $option;
                          $sql = "select * from mstr_country where id='1' and id!=101 order by id asc";
                          $result = mysqli_query($db, $sql);
                          while($row1 = mysqli_fetch_array($result))
                          {
                            $option="<option value='".$row1["id"]."'>".$row1['name']."</option>";
                            echo $option;
                          }
                        ?>
                      </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-8 text-left">
                    ...
                    <?php
                    $sql = "select * from mstr_state where id='$row[19]' and id!=101 order by id asc";
                        $result = mysqli_query($db, $sql);
                        while($row1 = mysqli_fetch_array($result))
                        {
                            ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="<?php echo $row[17];?>" class="form-control" name="txtCustomerBillingCity" id="txtCustomerBillingCity"  onkeyup="written(this.id);" placeholder="City"  >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<?php echo $row[19];?>" name="txtCustomerBillingPin" onkeyup="written(this.id);" id="txtCustomerBillingPin" placeholder="PIN"  >
          ...
          <!-- Right Details -->
            <div class="col-lg-6 mt-1">
             ...
             <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<?php echo $row[20];?>" name="txtCustomerShippingAddressLine1" onkeyup="written(this.id);" id="txtCustomerShippingAddressLine1" placeholder="Address Line 1" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<?php echo $row[21];?>" name="txtCustomerShippingAddressLine2" onkeyup="written(this.id);" id="txtCustomerShippingAddressLine2" placeholder="Address Line 2"  >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<?php echo $row[22];?>" name="txtCustomerShippingAddressLine3" id="txtCustomerShippingAddressLine3" placeholder="Address Line 3" >
                ...
                <div class="form-group row">
                  <label  class="col-lg-4 col-form-label" >Country></label>
                    <div class="col-lg-8 text-left">
                      ...
                      <?php
                        $sql = "select * from mstr_country where id='$row[23]' and id!=101 order by id asc";
                        $result = mysqli_query($db, $sql);
                        while($row1 = mysqli_fetch_array($result))
                        {
                            ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-8 text-left">
                    ...
                    <?php
                    $sql = "select * from mstr_state where id='$row[25]' and id!=101 order by id asc";
                        $result = mysqli_query($db, $sql);
                        while($row1 = mysqli_fetch_array($result))
                        {
                            ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<?php echo $row[24];?>" name="txtCustomerShippingCity" onkeyup="written(this.id);" id="txtCustomerShippingCity" placeholder="City"  >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<?php echo $row[26];?>" name="txtCustomerShippingPin" onkeyup="written(this.id);" id="txtCustomerShippingPin" placeholder="PIN" >
...
function Save_data()
{
  ...
  //alert("newRawItemArray:"+newRawItemArray);
    ...
    if(first_name!="" && company_name!="" && Customer_work_phone!="" && Customer_mobile!="" && comboCustomerOrderingCurrency!=""    
    ...
    && ship_city!="" && ship_pin!="" && gstin!="")
      ...
      $.ajax({
							type: "POST",
							url: '../../api/vendor/update_vendor.php',
							data: $('#form').serialize()+'&contact_person_array=' + newRawItemArray + '&edit_id=' + <?php echo $edit_id;?>,
							success: function(data)
							{ 
...
var t="";
  $(document).ready(function()
  {
    ...
    searching:true,
    ajax: {
            "url": "../../api/vendor/fetch_vendor_contact_person.php",
            "type": "POST",
            data : 
             {
             'edit_id' : edit_id
 ...
 $('#tbl tbody').on( 'click', 'button', function () 
    {
      ...
      if(action=="edit")
      {
        ...
        //alert(data[8]); 
        $('#Salutationcp').val = data[3];
          document.getElementById('txtFirstName').value = data[4];
          document.getElementById('txtlastName').value = data[5];
          document.getElementById('email_cp').value = data[6];
          document.getElementById('work_ph_cp').value = data[7];
          document.getElementById('mobile_cp').value = data[8];
