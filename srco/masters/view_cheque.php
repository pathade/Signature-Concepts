                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-2 col-sm-2 mobile-width">                                  
                                        <a href="add_cheque.php" style="float: left;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                    //$sql_charges="SELECT mc.*,mb.account_no,mb.bank_name FROM mstr_cheque mc,mstr_bank mb where mc.bank_id_fk=mb.bank_idpk";
                                   if($flag == 0) {
                                    $sql_charges="SELECT *,c.status as ss FROM `mstr_cheque` as c,mstr_bank as b where c.bank_id_fk = b.bank_idpk and c.flag='0' and b.flag='0'";
                                   }
                                   else {
                                       $sql_charges="SELECT *,c.status as ss FROM `mstr_cheque` as c,mstr_bank as b where c.bank_id_fk = b.bank_idpk and c.flag='1' and b.flag='1'";
                                   }
                                ...
                                if($result_charges != "")
                                {
                                    ...
                                    <tr style="cursor: pointer">
                                        ...
                                        <td style="display: flex;">
                                            <a href="edit_cheque.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row['cheque_id_pk'];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                                  
                                            </a>
                                            <a onclick="return confirm('Are you want to delete?')" href="delete_cheque.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row['cheque_id_pk'];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
                                                <i class="fa fa-trash" aria-hidden="true"></i>
                                                  
                                            </a>
                                        </td>
                                        <td><?php echo $row['cheque_id_pk']; ?></td>
                                        <td><?php echo $row['bank_name']; ?> </td>
                                        <td>
                                        <?php echo $row['account_no']; ?>
                                        </td>
                                        <td><?php echo $row['from_series']; ?></td>
                                        <td><?php echo $row['to_series']; ?></td>                                       
                                        <td><?php echo $row['current_cheque_no']; ?></td>
                                        <!-- <td><?php echo $row['ss']; ?></td> -->
                                        <td ><?php if( $row['ss'] == 'InComplete'){?><span class="text-danger"><?php echo $row['ss'];?></span><?php }else{?><span class="green-text"><?php echo $row['ss'];?></span><?php } ?></td>
                                        <td>
                                            <?php 
	...
	$(document).ready(function()
  {
    $('#tbl').DataTable( {
        ...
        "createdRow": function (row, data, dataIndex){
            if( data[9] ==  `<p style="color: #DA4453;">Inactive</p>`){
