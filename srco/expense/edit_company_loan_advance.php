...
<?php 
    ...
    $edit_id = $_GET['id'];
    $sql_charges="SELECT DISTINCT ca.*, mca.LAM_id_pk , mca.name 
    FROM exp_company_loan_advance ca,mstr_loan_advance_master mca where ca.vendor_id_fk= mca.LAM_id_pk and com_id_pk = '$edit_id'";
    ...
    while ($row=mysqli_fetch_row($result_charges))
    {
        ...
        if($bank_id != "")
        {
            $h = "SELECT * FROM mstr_bank WHERE bank_idpk='$bank_id'";
            $mk = mysqli_query($db,$h);
            while($gh = mysqli_fetch_array($mk))
            {
                $bank_Name = $gh['bank_name'];
            }
        }
        else
        {
		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Update Company Loans And Advances</h4>
                    <hr>
	                    ...
	                    <form class="form form-horizontal" method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" id="com_loan_form1">
	                    	<div class="form-body">
                                <div class="row">
                                                    ...
                                                    <label class="col-md-3 label-control" for="userinput1">Type <span style="color:red;">*</span></label>
                                                        <?php 
                                                            ...
                                                            <?php
                                                                    ...
                                                                    ?>
                                                                    <div class="col-md-4" style="display: flex;font-size: 16px;">
                                                                        <input type="radio" class="form-control " name="type" id="receipt" style="height: calc(2.75rem + -23px);width: 20px;margin-top: 3px;"  value="1" >&nbsp; Receipt
                                                                    </div>
                                                                    <?php
                                                                }
                                                                if($row[1] == 0 )
                                    ...
                                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">Transaction Date <span style="color:red;">*</span></label>
				                        	<div class="col-md-9">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="col-md-6">
			                        	<div class="form-group row">
											...
											<div class="col-md-9">
											<input type="number" id="cheque_no" value="<?php echo $row[8];?>" class="form-control " placeholder="" name="cheque_no" >
				                            </div>
			                       		</div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        //  echo   $my_date=date(d.m.Y,$date1);
                                            ...
                                            ?>
												<input type="text" class="form-control" value="<?php echo $row[9]; ?>" id="cheque_date" name="cheque_date" />
				                            </div>
				                        </div>
				                    </div>
                                    <?php 
				                        ...
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<select class="select2 form-control block" id="bank_name" class="select2" onchange="getAccountNo()" data-toggle="select2" name="bank_name">
                                                    <option value="<?php echo $row[6];?>" selected disabled><?php echo $row5[1]; ?></option>
                                                    <?php
                                                        echo $option;
                                                        $sql =  "SELECT distinct bank_name FROM mstr_bank order by bank_name asc";  // Use select query here 
                                                        $result = mysqli_query($db, $sql);
                                        ...
                                        <label class="col-md-3 label-control" for="userinput1">Account No</label>
											<div class="col-md-9">
												<select class="select2 form-control block" id="account_no" class="select2" data-toggle="select2" name="account_no" data-placeholder="Select Account No" >
                                                    <option selected value="<?php echo $row[7];?>"><?php echo $row5[2];?></option>
                                                        <?php 
                                    ...
                                    <div class="col-md-6">
										<div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<input type="number" class="form-control"  placeholder="" name="amount" id="amount" value="<?php echo $row[10];?>" >
				                            </div>
				                        </div>
                                    </div>
                                    <div class="col-md-6">
...
<script>
	...
	function getAccountNo()
  {
    ...
    function save_data()
    {
        ...
        if(pay_mode!=''  && paytype!=undefined && name!="" && amount!="")
        {
            if(pay_mode == "Cheque")
            {
