                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                if($flag == 0) {
                                    $sql_charges="SELECT * FROM exp_advance_payment_cancellation where flag='0'";
                                }
                                    else {
                                        $sql_charges="SELECT * FROM exp_advance_payment_cancellation where flag='1'";
                                    }
                                ...
                                if($result_charges != "")
                                {
                                    ...
                                    <tr style="cursor: pointer">
                                        ...
                                        <td ><?php if( $row[1] == 'Finance'){?><span class="green-text"><?php echo "Finance";?></span><?php }else{?><span class="text-success"><?php echo "Expenses";?></span><?php } ?></td>
                                        ...
                                        if ($row[1] == 'Finance') {
                                            if($flag == 0) {
                                                $sql1 = "SELECT DISTINCT supplier_id_fk,name FROM mstr_supplier 
                                                WHERE supplier_id_fk = $row[5] and flag='0'";
                                            }
                                            else {
                                                $sql1 = "SELECT DISTINCT supplier_id_fk,name FROM mstr_supplier 
                                            WHERE supplier_id_fk = $row[5] and flag='1'";
                                            }
                                            ...
                                            if($flag == 0){
                                                ...
                                                FROM mstr_vendor WHERE vendor_id_pk = $row[5] and flag='0'";
                                            }
                                            else {
                                                $sql1 = "SELECT DISTINCT vendor_id_pk,saturation, first_name, last_name 
                                            FROM mstr_vendor WHERE vendor_id_pk = $row[5] and flag='1'";
                                            }
                                            $result1 = mysqli_query($db, $sql1);
                                            if($result1 != "")
                                            {
