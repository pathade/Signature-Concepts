                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-1 col-sm-12 border-right-blue-grey border-right-lighten-5">
                            ...
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="#">Approvaed </a>
                        ...
                        <div class="col-lg-2 col-sm-12">
                            ...
                            <a href="add_sales_order.php"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                        </div>
                        <div class="col-lg-1 ">
			...
			<div class="card">
				...
				<div class="card-content collapse show">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <h5 style="margin-left: 37px;">Create, customize and print professional Delivery Challans</h5>	
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-6">
                                <a href="add_delivery_challan.php"><button class="btn btn-success btn-lg">Create Delivery Challan</button></a>
                            </div>
                    </div>
				</div>
			</div>
