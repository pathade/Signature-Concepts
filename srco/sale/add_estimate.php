                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;"><i class="fa fa-calculator" aria-hidden="true"></i>New Estimate</h4>
                                <hr>
                                    ...
                                    <form class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1" style="color:red;">Estimate#*</label>
                                                        <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1" style="color:red;">Estimate Date *</label>
                                                        <div class="col-md-3">
                                                        <input type="text" class="form-control " placeholder="" name="company_name" id="company_name">
                                                        </div>
                                                        <label class="col-md-2 label-control" for="userinput1">Expiry Date *</label>
                                                        <div class="col-md-3">
                                                        <input type="text" class="form-control " placeholder="" name="company_name" id="company_name">
                                                        </div>
                                                    </div>
