                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;"><i class="fa fa-cart-plus" aria-hidden="true"></i>New Sales Order</h4>
                                <hr>
                                    ...
                                    <form class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1" style="color:red;">Sales Order#*</label>
                                                        <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1" style="color:red;">Sales order Date *</label>
                                                        <div class="col-md-3">
                                                        <input type="date" class="form-control " placeholder="" name="company_name" id="company_name">
                                                        </div>
                                                        <label class="col-md-2 label-control" for="userinput1">Payment Terms</label>
                                                        <div class="col-md-3">
                                                            <select class="select2 form-control block" id="Salutation" class="select2" data-toggle="select2" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1">Delivery Method</label>
                                                        <div class="col-md-3">
                                                        <select class="select2 form-control block" id="Salutation" class="select2" data-toggle="select2" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1">Sales Person</label>
                                                        <div class="col-md-3">
                                                        <select class="select2 form-control block" id="Salutation" class="select2" data-toggle="select2" >
                                                            <option value="" disabled selected>Select Sales Person </option>
                                                            <option value="PCS">Javed Habib</option>
                                                        </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1">Subject</label>
                                                        <div class="col-md-7">
                                                        <input type="text" class="form-control " placeholder="Let your customer know what this estimate is for" name="" id="company_name">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
