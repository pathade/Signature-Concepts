		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">New Purchase Order</h4>
                    <hr>
                                ...
                                <div class="row" style="visibility: hidden;">
                                    <div class="col-md-6">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM mstr_data_series where name='exp_purchase_order'";
