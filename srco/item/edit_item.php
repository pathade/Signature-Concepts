<?php include('../../partials/header.php');
    $edit_id = $_GET['id'];
	//$sql = "SELECT * FROm mstr_item where item_id_pk = '$edit_id'";
	$sql = "SELECT * FROM mstr_item as i,mstr_customer as c WHERE c.cust_id_pk = i.cust_id_fk 
	AND i.delete_status='0' AND item_id_pk = '$edit_id' order by item_id_pk DESC";
    ...
    while($rw = mysqli_fetch_array($f))
    {
        ...
        $item_type =  $rw['item_type'];
        $hsn =  $rw['hsn'];
        $nks_code =  $rw['nks_code'];
        $design_code =  $rw['design_code'];
        $final_product_code =  $rw['design_code'];
        $size =  $rw['size'];
        $pcs =  $rw['pcs'];
        $uom =  $rw['uom'];
		...
		<div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls">Edit Item<div id="result"></div></h4>
                                ...
                                <div class="row">
	                    			<div class="col-md-4">
				                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">Type <span style="color:red;"> *</span>
                                            <!-- <i class="fa fa-question-circle-o " data-toggle="tooltip" data-placement="right" title="Select if this item is a physical good or a service you're offering.Also,remember that once you include this item in a transaction, you cannot change its type."></i> -->
                                            </label>
				                        	<div class="col-md-9">
												...
												<select class="select2 form-control block" id="responsive_single4" class="select2" data-toggle="select2" name="item_type" required="">
												<option value="<?php echo $cust_id_fk?>"><?php echo $company_name;?></option>
												<?php 
				                    ...
				                    <div class="col-md-4">
                                        ...
                                        <label class="col-md-4 label-control" for="userinput1"><span style="color:red;">* </span>Item Name 
				                        	...
				                        	<div class="col-md-8">
												<input type="text" id="item_name" class="form-control " value="<?php echo $item_name; ?>" placeholder="" name="item_name" required="" onkeyup="written(this.id);">
				                    ...
				                    <div class="col-md-4">
                                        ...
                                        <label class="col-md-4 label-control" for="userinput1"><span style="color:red;">* </span>HSN/SAC 
				                        	...
				                        	<div class="col-md-8">
												<input type="text" id="HSN" class="form-control "  value = "<?php echo $hsn;?>" placeholder="" name="HSN" required="" onkeyup="written(this.id);">
	       ...
	       <!--             			<div class="col-md-4">-->
				    ...
				    <!--                    	<div class="col-md-9">-->
				    <!--                        	<input type="text" id="nks_code" class="form-control " value = "<?php echo $nks_code;?>" placeholder="" name="nks_code" onkeyup="written(this.id);">-->
				    ...
				    <!--                    	<div class="col-md-8">-->
				    <!--                        	<input type="text" id="design_code" class="form-control " value = "<?php echo $design_code;?>" placeholder="" name="design_code" onkeyup="written(this.id);">-->
				    ...
				    <!--                    	<div class="col-md-7">-->
				    <!--                        	<input type="text" id="final_product" class="form-control "  value = "<?php echo $final_product_code;?>" placeholder="" name="final_product" onkeyup="written(this.id);">-->
				    ...
				    <!--                </div>-->
								...
								<div class="row">
									<!--<div class="col-md-4">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="size" class="form-control " placeholder="NA" name="size" value = "<?php echo $size;?>" onkeyup="written(this.id);">
									...
									<div class="col-md-4">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-8">
                                                ...
                                                <option value="<?php echo $pcs;?>"><?php echo $pcs;?></option>
									...
									<div class="col-md-4">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<select class="select2 form-control block" id="responsive_single3" value = "<?php echo $uom;?>" class="select2" data-toggle="select2" name="uom">
		                        ...
		                        <div class="row">
		                        	<div class="col-md-4">
                                        ...
                                        <label class="col-md-3 label-control" for="userinput1"><span style="color:red;">* </span>GST Group(%)
				                        	...
				                        	<div class="col-md-9">
												<input type="text" id="gst_group" class="form-control " placeholder="" value = "<?php echo $gst_group;?>" name="gst_group" onkeyup="written(this.id);">
									...
									<div class="col-md-4">
                                        ...
                                        <label class="col-md-4 label-control" for="userinput1"><span style="color:red;">* </span>Sale Rate
				                        	...
				                        	<div class="col-md-8">
												<input type="text" id="sale_rate" class="form-control " placeholder="" value = "<?php echo $sale_rate;?>" name="sale_rate" onkeyup="written(this.id);">
									...
									<div class="col-md-4">
                                        ...
                                        <label class="col-md-5 label-control" for="userinput1"><span style="color:red;">* </span>Purchase Rate
				                        	...
				                        	<div class="col-md-7">
												<input type="text" id="purchase_rate" class="form-control " placeholder="" value = "<?php echo $purchase_rate;?>" name="purchase_rate" onkeyup="written(this.id);">
	                        ...
	                        <div class="form-actions right">
	                            ...
	                            <a href="view_item.php"><button type="button" class="btn btn-warning mr-1">
                                    Cancel
	                            </button></a>
...
<script>
	function Save_data()
	{
		...
		if(type!="" && HSN!="" && item_name!="" && uom!="" && gst_group!="" && sale_rate!="" && purchase_rate!="" )
		{
		
			$.ajax({
							type: "POST",
							url: '../../api/item/edit_item.php',
							data: $('#form').serialize() + "&edit_id=" + <?php echo $edit_id;?> ,
