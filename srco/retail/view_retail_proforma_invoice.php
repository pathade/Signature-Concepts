...
<?php
    // echo "SESSIOn: ".$_SESSION['flag'];
    $flag=$_SESSION['flag'];
    if($flag==0)
    {
        $view_retail_proforma = "SELECT * FROM retail_proforma WHERE flag='$flag'";
        $res_retail_proforma = mysqli_query($db, $view_retail_proforma) or die(mysqli_error($db));
    }
    else if($flag==1)
    {
        $view_retail_proforma = "SELECT * FROM retail_proforma WHERE flag='$flag'";
    ...
    // $view_retail_proforma = "SELECT * FROM retail_proforma";
    // $res_retail_proforma = mysqli_query($db, $view_retail_proforma) or die(mysqli_error($db));
?>
                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-1 mobile-width">                                 
                                            <a href="add_retail_proforma_invoice.php" style="float: left;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <tbody>
                                <?php while($row =  mysqli_fetch_row($res_retail_proforma))
                                { 
                                    if($row[19] == 1)
                                    {
                                        //color row
                                        ?>
                                        <tr style="cursor: pointer;background-color: indianred !important;" >
                                        
                                        <td></td>
                                        <td style="display: flex;">
                                       
                                            <a href="edit_retail_proforma_invoice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                            ...
                                            if($flag==0)
                                            { ?>
                                            <a href="../../fpdf/api/retail_performa_invoice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-print" aria-hidden="true"></i>
                                                  
                                            </a>
                                            <?php } 
                                            else { ?>
                                            <a href="../../fpdf/api/retail_performa_invoice_raw.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-print" aria-hidden="true"></i>
                                                  
                                            </a>
                                            <?php } ?>
                                            
                                            <!-- <a href="../../api/retail/delete_retail_proforma_invoice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
                                        ...
                                        ?>
                                            <a onclick="return confirm('Are you sure you want to delete?')" href="../../api/retail/delete_retail_proforma_invoice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
                                                <i class="fa fa-trash" aria-hidden="true"></i>
                                        ...
                                        <?php 
                                            ...
                                            else 
                                            {
                                                ...
                                                <button class="btn btn-danger btn-sm" onclick="edit_check();"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                                <?php
                                            }
...
function edit_check()
{
    ...
    $.toast({
            heading: 'Error',
            text: 'Can not delete..Tax Invoice Generated! If You Want to delete Proforma Invoice then delete generated tax invoice fisrt!',
