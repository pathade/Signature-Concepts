...
<?php 
    $edit_id = $_GET['id'];
    $sql = "SELECT * FROM retail_return_goods WHERE id_pk='$edit_id'";
    $row = mysqli_fetch_row(mysqli_query($db, $sql)) or die(mysqli_error($db));
...
<form method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>">
		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">New Retail Return Goods</h4>
                    <hr>
	                    	...
	                    	<div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php 
                                            $get_return_no = "SELECT sr_no FROM mstr_data_series WHERE name='retail_return_goods'";
                                            $res_return_goods = mysqli_fetch_row(mysqli_query($db, $get_return_no));
                                        ?>
                                        	<label class="col-md-3 label-control" for="userinput1">Return No.</label>
				                        	<div class="col-md-3">
												<input type="text" id="return_no" class="form-control " value="<?php echo $row[1] ?>" name="return_no" readonly>
											</div>
                                    ...
                                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                ...
                                                <select class="select2 form-control block" id="customer" onchange="fetchCustomerData(this.value)" class="select2" data-toggle="select2" name="customer">
                                                <?php 
                                                    $get_cust = "SELECT retail_cust_name FROM mstr_retail_customer WHERE retail_cust_idpk='$row[3]'";
                                                    $res_cust = mysqli_fetch_row(mysqli_query($db, $get_cust));

                                                    echo '<option value="'.$row[3].'">'.$res_cust[0].'</option>';
                                                ?>
                                               
												</select>
                                                <!-- <span id="customer_error" class="text-danger">Customer Required!</span> -->
                                            </div>
				                        </div>
				                    </div>
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">Proforma Inv. No <span style="color:red;">*</span></label>
				                        	<div class="col-md-9">
                                                ...
                                                <?php 
                                                    ...
                                                    echo '<option value="'.$row[4].'">'.$res_pro_no[0].'</option>';
                                                ?>
                                               
												</select>
                                                <!-- <span id="pono_error" class="text-danger">Proforma Inv. No. Required!</span> -->
                                            </div>
				                        </div>
				                    </div>
                                </div>
                                <div class="row">
	                    			<div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 ">
                                                <textarea type="text" class="form-control" rows="4"  placeholder="Address" name="address" id="address" style="height: auto;" readonly><?php echo $row[6] ?></textarea>
                                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
                                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                <input type="number" id="mobile_no" class="form-control " placeholder="0" value="<?php echo $row[5] ?>" name="mobile_no" readonly>
                                            </div>
			                       		</div>
                                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">Transporter <span style="color:red;">*</span></label>
				                        	<div class="col-md-3">
                                                <select class="select2 form-control js-example-tags" data-toggle="select2" id="transporter" name="transporter" >
                                                    <option value="" disabled selected>Select </option>
                                                    <?php
                                                        $get_transporter = "SELECT t_id_pk, name FROM mstr_transporter Where tactive_status='1'";
                                                        $res_transporter = mysqli_query($db, $get_transporter) or die(mysqli_error($db));
                                                        while($row1 = mysqli_fetch_row($res_transporter))
                                                        {
                                                            echo '<option value="'.$row1[0].'">'.$row1[1].'</option>';
                                                        }
                                                    ?>
												</select>
                                                <!-- <span id="transporter_error" class="text-danger">Transporter Required!</span> -->
                                            </div>
                                            <label class="col-md-2 label-control" for="userinput1">Vehicle <span style="color:red;">*</span></label>
				                        	<div class="col-md-4">
                                                <select class="select2 form-control js-example-tags" data-toggle="select2" id="vehicle" name="vehicle" >
                                                    <option value="" disabled selected>Select </option>
                                                    <?php
                                                        $get_tvehicle = "SELECT tv_id_pk, v_name FROM mstr_transporter_vehicle WHERE v_status='1'";
                                                        $res_tvehicle = mysqli_query($db, $get_tvehicle) or die(mysqli_error($db));
                                                        while($row2 = mysqli_fetch_row($res_tvehicle))
                                                        {
                                                ...
                                                <!-- <span id="vehicle_error" class="text-danger">Vehicle Required!</span> -->
                                            </div>
				                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
	                    			<div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 ">
                                                <textarea type="text" class="form-control" rows="4"  placeholder="" name="remark" id="remark" style="height: auto;"></textarea>
                                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="userinput1">ChequeNo.</label>
				                        	<div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="0" id="cheque_no" name="cheque_no" readonly />
                                            </div>
                                ...
                                <div class="row">
	                    			<div class="col-md-6">
                                        <div class="form-group row ml-0">
                                            <!-- <input type="radio" id="return_goods" name="bank_type" style="height: 17px;width: 20px;" value="Return Goods" /> &nbsp;Return Goods  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" id="add_qty" name="bank_type" style="height: 17px;width: 20px;" value="Add Qty in PO" /> &nbsp;Add Qty in PO  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                                            <input type="radio" id="cash_back" name="bank_type" style="height: 14px;width: 14px;" value="Cash Back" checked /> &nbsp;Cash Back  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" id="cheque_back" name="bank_type" style="height: 14px;width: 14px;" value="Cheque Back" /> &nbsp;Cheque Back 
				                        </div>
				                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
        ...
        $(document).ready(function()
        {
            ...
            window.setInterval(function()
            {
                ...
                for(var i=0;i<count;i++)
                {
                    ...
                    var tbl12 = table.cell(i, 14).nodes().to$().find('input').val();
            ...
            if(table_discount==''){
                ...
                function get_final_amount(e) {
                    ...
                    if(adjustment_final=='' && process_amount=='' ){
                        ...
                        document.getElementById("final_total").value=final_amount.toFixed(4);
                    }
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            { 
                ...
                var return_quantity =table.cell(i,4).nodes().to$().find('input').val();
                ...
                var return_amount=table.cell(i,10).nodes().to$().find('input').val();
                var gst_per=table.cell(i,11).nodes().to$().find('input').val();
                var cgst=table.cell(i,12).nodes().to$().find('input').val();
                var sgst=table.cell(i,13).nodes().to$().find('input').val();
                var igst=table.cell(i,14).nodes().to$().find('input').val();
                var remark=table.cell(i,15).nodes().to$().find('input').val();
            ...
            var bankType = document.getElementsByName('bank_type');
            var bank_type = '';
            bankType.forEach((bt, index) => {
                if(bt.checked)
                    bank_type = bt.value;
                    if(bank_type == 'Cheque Back')
                        cheque_no1 = cheque_no;
                    else if(bank_type == 'Cash Back')
                        cheque_no1 = 0;
                    else
                        cheque_no1 = 0;
            ...
            var trans_amt = document.getElementById('trans_amt').value;
            ...
            $.ajax(
            {
                ...
                url: "../../api/retail/add_retail_return_goods.php",
                type: 'POST',
                data : {
                ...
                { 
                    ...
                    if(data == "1")
                    {
                        $.toast({
                                    heading: 'Success',
                                    text: 'Retail Return Goods Added!',
                                    showHideTransition: 'slide',
                                    position: 'top-right',
                                    hideAfter: 5000,
                                    icon: 'success'
                                })
                                $('#add_retail_tax_invoice').attr('disabled', true);
                                setTimeout(() => 
                                {
                                    window.location.href="view_retail_return_goods.php";    
                                }, 5000);
                        // alert("Retail Return Goods Added!")
                        // $('#add_retail_tax_invoice').attr('disabled', true);
                        // $('#pdf_btn').css('display', 'inline-block');
                        //  window.location.href="view_retail_return_goods.php";
                    }
                    else
                    {
    ...
    <script>
        function getProInvItems(e)
        {
            ...
            $.ajax({
                ...
                $.each(data, function(index) 
                {
                    ...
                    var product_category=`<select class="select2 form-control" id="category-${i}" onchange="get_category(this.id)"><option>${data[index].product_category}</option></select>`; 
                    var product_design=`<select class="select2 form-control" id="item_id-${i}" onchange="get_item(this.id)"><option value="${data[index].item_id_fk}">${data[index].product_design}</option></select>`; 
                    var size=`<input type="text" id="size-${i}" value="${data[index].size}" class="form-control" />`; 
                    var qty=`<input type="text" id="_quantity-${i}" value="${data[index].qty}" class="form-control" />`; 
                    var return_qty=`<input type="text" id="quantity-${i}" onkeyup="get_quantity_value(this.id);" value="${data[index].qty}" class="form-control" />`; 
                    ...
                    var amount=`<input type="text" id="_amount-${i}" value="${data[index].amount}" class="form-control" />`; 
                    var return_amount=`<input type="text" id="amount-${i}" value="${data[index].amount}" class="form-control" />`; 
        ...
        {   
            ...
            $.ajax({
                type: "POST",
                url:"../../api/retail/get_pro_inv_no1.php",
                data: { 'name': name },
                dataType: 'json',
                success:function(data)
                {
