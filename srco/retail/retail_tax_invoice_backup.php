	                    ...
	                    <form class="form form-horizontal" id="form" data-toggle="validator" role="form">
	                    	<div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    ?>
			                        	<div class="form-group row">
				                        	...
				                        	<div class="col-md-3">
												<input type="text" id="pi_no" class="form-control " placeholder="" name="pi_no" readonly value="<?php echo $res1[0] ?>" >
											</div>
                                    ...
                                    <div class="col-md-6">
				                        <div class="form-group row">
                                            ...
                                            <select class="select2 form-control block" id="customer" class="select2" data-toggle="select2" name="customer" onchange="fetchCustomerData(this.value)">
                                                ...
                                                <?php
                                                    $get_customer = "SELECT retail_cust_name FROM mstr_retail_customer";
                                ...
                                <div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">Pro. Order No</label>
				                        	<div class="col-md-9">
                                ...
                                <div class="row">
	                    			<div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 ">
                                                <textarea type="text" class="form-control" rows="7"  placeholder="Address" name="address" id="address" style="height: auto;" readonly></textarea>
                                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-3">
                                                <select class="form-control" id="transporter" name="transporter" >
                                                    <option value="" disabled selected>Select </option>
                                                    <?php
                                                    $get_transporter = "SELECT t_id_pk, name FROM mstr_transporter";
				                        	...
				                        	<div class="col-md-4">
                                                <select class="form-control" id="vehicle" name="vehicle" >
                                                    <option value="" disabled selected>Select </option>
                                                    <?php
                                                    $get_vehicle = "SELECT tv_id_pk, v_name FROM mstr_transporter_vehicle";
                                                    ...
                                                    <table class="border-bottom-0 table table-hover table-responsive" id="tbl" >
                                                                ...
                                                                <tbody>
                                                                    <!-- <tr>
                                                                        ...
                                                                        <td><input type="text" id="gst_per-0" class="form-control" value="18" /></td>
                                                                        <td><input type="text" id="cgst-0" class="form-control" value="0.00" /></td>
                                                                        <td><input type="text" id="sgst-0" class="form-control" value="0.00" /></td>
                                                                        <td><input type="text" id="igst-0" class="form-control" value="0.00" /></td>
...
<script>
    ...
    $('#add_new_line').click(function() {
        ...
        var gst_per="<input type='text' id='gst_per-"+i+"' class='form-control' value='18' />";
        var cgst="<input type='text' id='cgst-"+i+"' class='form-control' value='0.00' />";
        var sgst="<input type='text' id='sgst-"+i+"' class='form-control' value='0.00' />";
        var igst="<input type='text' id='igst-"+i+"' class='form-control' value='0.00' />";
...
<script>
    $(document).ready(function(){
        ...
        $.ajax(
        {
            ...
            url: "../../api/retail/add_retail_tax_invoice.php",
            type: 'POST',
            data : {
            ...
            { 
                ...
                if(data == "1")
                {
                    ...
                    // icon: 'error'
                    // })
                    alert("Retail Tax Invoice Added!")
    ...
    function getProInvItems(e)
    {
        ...
        $.ajax({
            ...
            $.each(data, function(index) 
            {
                ...
                var amount=`<input type="text" id="amount-${i}" value="${data[index].amount}" class="form-control" />`; 
                var gst_per=`<input type="text" id="gst_per-${i}" value="18" class="form-control" />`; 
                var cgst=`<input type="text" id="cgst-${i}" value="0.00" class="form-control" />`; 
                var sgst=`<input type="text" id="sgst-${i}" value="0.00" class="form-control" />`; 
                var igst=`<input type="text" id="igst-${i}" value="0.00" class="form-control" />`; 
