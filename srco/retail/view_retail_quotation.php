...
<?php
    ...
    // if($flag==0)
    // {
        $view_retail_quotation = "SELECT * FROM retail_quotation WHERE flag='$flag'";
        $res_retail_quotation = mysqli_query($db, $view_retail_quotation) or die(mysqli_error($db));
    // }
    // $view_retail_quotation = "SELECT * FROM retail_quotation";
    // $res_retail_quotation = mysqli_query($db, $view_retail_quotation) or die(mysqli_error($db));
?>
                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-1 mobile-width">                                 
                                            <a href="add_retail_quotation.php" style="float: left;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <tbody>
                                <?php while($row =  mysqli_fetch_row($res_retail_quotation))
                                { ?>
                                    <tr style="cursor: pointer">
                                        
                                        <td></td>
                                        <td style="display: flex;">
                                            <a href="edit_retail_quotation.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                                  
                                            </a>
                                            
                                            <a onclick="return confirm('Are you sure you want to delete?')" href="../../api/retail/delete_retail_quotation.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
                                            ...
                                            if($flag==0)
                                            { ?>
                                            <a href="../../fpdf/api/tiles_quotation.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-print" aria-hidden="true"></i>
                                            </a>
                                            <?php } 
                                            else { ?>
                                            <a href="../../fpdf/api/tiles_quotation_raw.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-print" aria-hidden="true"></i>
                                            </a>
                                            <?php } ?>
                                        </td>
