...
<form method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>">
	                    ...
	                    <form class="form form-horizontal" id="form" data-toggle="validator" role="form">
	                    	<div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
                                                ...
                                                <?php
                                                $get_customer_id = "SELECT t.customer,c.retail_cust_name FROM `retail_tax_invoice` as t,mstr_retail_customer as c where t.customer = c.retail_cust_idpk
                                                ";
                                                $res = mysqli_query($db,$get_customer_id);
	                    			...
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	<label class="col-md-3 label-control" for="userinput1">Performa Tax Inv. No</label>
				                        	<div class="col-md-9">
                                ...
                                <div class="row">
				                    ...
				                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-3">
                                                <input type="text" class="form-control" value="0" id="cheque_no" name="cheque_no" readonly />
                                            </div>
        ...
        $(document).ready(function()
        {
            ...
            window.setInterval(function()
            {
                ...
                for(var i=0;i<count;i++)
                {
                    ...
                    var tbl2=table.cell(i,5).nodes().to$().find('input').val()
                    ...
                    var tbldisc=table.cell(i,8).nodes().to$().find('input').val()
                    ...
                    var tbl12 = table.cell(i, 15).nodes().to$().find('input').val();
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            { 
                ...
                var return_amount=table.cell(i,11).nodes().to$().find('input').val();
                var gst_per=table.cell(i,12).nodes().to$().find('input').val();
                var cgst=table.cell(i,13).nodes().to$().find('input').val();
                var sgst=table.cell(i,14).nodes().to$().find('input').val();
                var igst=table.cell(i,15).nodes().to$().find('input').val();
                var remark=table.cell(i,16).nodes().to$().find('input').val();
            ...
            { 
                ...
                { 
                    ...
                    if(data == "1")
                    {
                        $.toast({
                        heading: 'Success',
                        text: 'Retail Return Goods Added Sussesfully',
    ...
    <script>
        function getProInvItems(e)
        {
            ...
            table.clear().draw();
            $.ajax({
                url: '../../api/retail/get_proforma_tax_invoice_table.php', 
                type: "POST",
                data : 
                {
                ...
                $.each(data, function(index) 
                {
                    ...
                    var qty=`<input type="text" id="_quantity-${i}" readonly value="${data[index].qty}" class="form-control" />`; 
                    ...
                    var amount=`<input type="text" style="width: auto" id="_amount-${i}" readonly value="${data[index].amount}" class="form-control" />`; 
        ...
        {   
            ...
            $.ajax({
                type: "POST",
                url:"../../api/retail/get_tax_inv_no.php",
                data: { 'name': name },
                dataType: 'json',
                success:function(data)
                {
