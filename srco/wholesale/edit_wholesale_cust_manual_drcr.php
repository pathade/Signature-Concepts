...
<?php 
    ...
    FROM `customer_manual_debit_credit` as cmdc,
          tbl_wholesale_customer as c ,mstr_tax as t
    WHERE cmdc.customer_id_fk=c.wc_id_pk AND cmdc.tax_id_fk = t.tax_id_pk AND id='$edit_id' ORDER BY cmdc.id DESC ";
		...
		<div class="col-md-12">
	        <div class="card">
				<div class="card-header">
	                <h4 class="card-title" id="horz-layout-colored-controls" style="font-size:40px;">Update Customer Manual Debit / Credit</h4>
                    <hr>
	                ...
	                <div class="card-body">
	                    ...
	                    <form class="form form-horizontal" method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" id="com_loan_form">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <?php if($row['credit_debit_type'] == "Debit"){?>
                                                    &nbsp;&nbsp;<input type="radio" class="form-control " name="type" id="debit" style="height: calc(2.75rem + -23px);width: 20px;margin-top:3px;"  value="Debit" checked>&nbsp; Debit 
                                                    <?php } else { ?>
                                                    ...
                                                    <div style="display: flex;font-size: 16px;">
                                                    <?php if($row['credit_debit_type'] == "Credit"){?>
                                                        <input type="radio" class="form-control " name="type" id="credit" style="height: calc(2.75rem + -23px);width: 20px;margin-top:3px;" value="Credit" checked>&nbsp; Credit
                                                    <?php } else { ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput1">Customer Type </label>
                                                    <div style="display: flex;font-size: 16px;">
                                                    <?php if($row['cust_type'] == "Retailer")
                                                    {?>
                                                    &nbsp;&nbsp;<input type="radio" class="form-control " name="customer_type" id="retailer" style="height: calc(2.75rem + -23px);width: 20px;margin-top:3px;"  value="Retailer" checked>&nbsp; Retailer 
                                                    <?php } else { ?>
                                                    ...
                                                    <div style="display: flex;font-size: 16px;">
                                                    <?php if($row['cust_type'] == "Wholesaler"){?>
                                                        <input type="radio" class="form-control " name="customer_type" id="wholesaler" style="height: calc(2.75rem + -23px);width: 20px;margin-top:3px;" value="Wholesaler" checked>&nbsp; Wholesaler
                                                    <?php } else { ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="select2 form-control block" id="customer_name" class="select2" data-toggle="select2" name="customer_name">
                                                            <option value="<?php echo $row['wc_id_pk'];?>" disabled selected><?php echo $row['cust_name'];?> </option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="select2 form-control block" id="authorised_by" class="select2" data-toggle="select2" name="authorised_by">
                                                            <option value="<?php echo $row['authorised_by'];?>" disabled selected><?php echo $row['authorised_by'];?> </option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="amount" name="amount" placeholder="0" value="<?php echo $row['amount'];?> " onkeyup="amount_entered()" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label class="col-md-3 label-control" for="userinput1">Total</label>
                                                    <div class="col-md-9">
                                                        <input type="text" value="<?php echo $row['total'];?> "  class="form-control" id="total" name="total" placeholder="0" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" id="tax" name="tax" onchange="gettaxamount(this.value)">
                                                            <option value="<?php echo $row['tax_id_pk'];?>"  disabled selected><?php echo $row['tax_name'];?> </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" value="<?php echo $row['tax_amount'];?>" class="form-control"  placeholder="0" name="tax_amt" id="tax_amt" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" class="form-control" value="<?php echo $row['other'];?>" onkeyup="other_entered();" placeholder="0" name="other" id="other">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" class="form-control"  value="<?php echo $row['final_amount'];?>" placeholder="0" name="net_amt" id="net_amt" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
										<div class="form-group row">
				                        	...
				                        	<div class="col-md-10 ">
                                                <textarea type="text" class="form-control" rows="3" id="reason" name="reason" style="height: auto;"><?php echo $row['reason'];?></textarea>
				                            </div>
				                        </div>
                                    </div>
                                </div>
	                        ...
	                        <div class="form-actions right">
                                ...
                                <button type="button" class="btn btn-primary" name="add" onClick="save_data1()">
    ...
    function save_data1()
    {
        ...
        && amount!="" && total!="" && net_amt!="")
        {
            $.ajax(
            {
                ...
                url: "../../api/wholesale/update_cust_manual_credit_debit.php",
                type: 'POST',
                data : $('#com_loan_form').serialize()+'&edit_id='+<?php echo $edit_id;?>+'&customer_name='+customer_name+'&authorised_by='+authorised_by+'&tax='+tax,
                dataType:'text',  
                ...
                { 
                    ...
                    if(data == "1") 
                    {
                        ...
                        $.toast({
                            heading: 'Success',
                            text: 'Customer Manual Debit Credit Updated',
