                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-1 mobile-width">                                 
                                        <a href="add_finance_payment_advice_cancellation.php" style="float: left;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php
                                if($flag == 0) {
                                    $sql_charges="SELECT * FROM fin_payment_advice_cancellation where flag='0' ";
                                }
                                else {
                                    $sql_charges="SELECT * FROM fin_payment_advice_cancellation where flag='1' ";
                                }
                                ...
                                if($result_charges != "")
                                {
                                    ...
                                    <tr style="cursor: pointer">
                                        ...
                                        <td style="display: flex;">
                                            <a href="edit_finance_payment_advice_cancellation.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
