...
<?php 
    ...
    $edit_id = $_GET['id'];
    $sql_charges="SELECT * FROM fin_payment_advice where id_pk = '$edit_id'";
                                ...
                                <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" id="branch" name="branch" readonly >
                                                            <option value="<?php echo $row[4]; ?>" disabled selected><?php echo $row[4]; ?></option>
                                                        </select>
                                                    </div>										
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                    <?php 
                                                     $supplier = "SELECT name FROM mstr_supplier WHERE supplier_id_fk='$row[3]'";
                                                     $res_s = mysqli_fetch_row(mysqli_query($db, $supplier));
                                                     ?>
                                                    <select class="select2 form-control block" id="supplier" class="select2" data-toggle="select2" name="supplier" >
                                                        <option value="<?php echo $row[3]; ?>" selected disabled><?php echo $res_s[0]; ?></option>
                                                        <?php

                                                            $sql = "SELECT supplier_id_fk FROM fin_purchase_invoice";
                                                            $result = mysqli_query($db,$sql);
                                                            while($row1 = mysqli_fetch_row($result))
                                                            {   
                                                                $get_supplier = "SELECT * FROM mstr_supplier WHERE supplier_id_fk='$row1[0]'";
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <?php 
                                                        $emp = "SELECT emp_name FROM mstr_employee WHERE emp_id_pk='$row[5]'";
                                                        $res_e = mysqli_fetch_row(mysqli_query($db, $emp));
                                                        ?>
                                                        <select class="select2 form-control block" id="authorised_by" class="select2" data-toggle="select2" name="authorised_by">
                                                            <option value="<?php echo $row[5]; ?>" selected disabled><?php echo $res_e[0]; ?></option>
                                                            <?php

                                                                $sql1 = "SELECT * FROM mstr_employee WHERE emp_status = 1";
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="date" id="date" class="form-control " name="date" value="<?php echo  $row['2']?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <!-- <table class="border-bottom-0 table table-hover" id="tbl" > -->
                                                                <thead>
                                                                    ...
                                                                    <?php
                                                                    $sql2="SELECT * FROM fin_payment_advice_items WHERE fpa_id_fk = $edit_id ";
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                    <tr>
                                                                        <td><input type="checkbox" value="" id="row_check" onchange="tax_invoice_click(this.id)" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['2']?>" id="pi_id" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['3']?>" id="supplier" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['4']?>" id="bill_no" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['5']?>" id="bill_amt" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['6']?>" id="prev_paid" class="form-control" onkeyup="getAmount(this.id)" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['7']?>" id="total" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['8']?>" id="grr_id" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['9']?>" id="grn" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['10']?>" id="netpayto_supplier" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['11']?>" id="manual_drid" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['12']?>" id="debit" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['13']?>" id="manual_crid" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['14']?>" id="credit" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['15']?>" id="adv_payment" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['16']?>" id="amount" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['17']?>" id="discount" class="form-control" onkeyup="getRowDiscountValue(this.id)" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['18']?>" id="total_pay" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['19']?>" id="other" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['20']?>" id="pay_amount" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                        <td><input value="<?php echo  $row2['21']?>" type="checkbox" class="d-none" id="apply_credit" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['22']?>" id="remark" class="input" onkeypress="this.style.width = ((this.value.length +  3) * 10) + 'px';" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['23']?>" id="grr_date" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['24']?>" id="grr_disp_no" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['25']?>" id="grr_disp_amt" class="form-control" /></td>
                                                                        <td><input type="text" value="<?php echo  $row2['26']?>" id="pi_drper" class="form-control" /></td>
                                                                    <tr>
                                                                    <?php
                                                                        }
                                                                    }              
...
<script>
    ...
    $('#add_purchase_order').click(function(){
        ...
        {
            $.ajax({
                url: '../../api/finance/update_fin_payment_advice.php',
                type: 'POST',
                data: {
