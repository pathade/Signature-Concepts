                            ...
                            <div class="card-body" style="padding: 0.5rem;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-1 mobile-width">                                 
                                            <a href="add_finance_payment_advice.php" style="float: left;"><button type="button" class="btn btn-success " ><i class="fa fa-plus"></i> NEW</button></a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered responsive" id="tbl">
                                ...
                                <?php 
                                    if($flag == 0){
                                        $get_pa = "SELECT * FROM fin_payment_advice where flag='0'";
                                    }
                                    else {
                                        $get_pa = "SELECT * FROM fin_payment_advice where flag='1'";
                                    }
                                    ...
                                    {?>
                                       <tr>
                                        ...
                                        <td style="display: flex;">
                                            <a href="edit_finance_payment_advice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-success btn-sm">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                            </a>
                                            
                                            <a onclick="return confirm('Are you want to delete?')" href="../../api/finance/delete_finance_payment_advice.php?bfiirbfr=dnfvibi&njsbuisv=sdmdfuiefb&id=<?php echo $row[0];?>&dhjsh=efnb&bbdhjrb=esfbehvf&ejgfebf=sdfbuyeg" class="btn btn-danger btn-sm">
                                        ...
                                        <?php 
                                        if($flag == 0){
                                        $sql1 = "SELECT name FROM mstr_supplier WHERE supplier_id_fk = $row[3] and flag='0'";
                                        }
                                        else {
                                            $sql1 = "SELECT name FROM mstr_supplier WHERE supplier_id_fk = $row[3] and flag='1'";   
                                        }
                                        ...
                                        <?php 
                                        if($flag == 0){
                                        $sql2 = "SELECT emp_name FROM mstr_employee WHERE emp_id_pk = $row[5] and flag='0' ";
                                        }
                                        else {
                                            $sql2 = "SELECT emp_name FROM mstr_employee WHERE emp_id_pk = $row[5] and flag='1' ";
                                        }
