...
function _Arc($x1, $y1, $x2, $y2, $x3, $y3)
 ...
 function Header()
 {
   ...
   //   }
     ...
     $this->Image('uploads/user.jpg',10,22.5,16);


     $this->SetFont('Arial','B',20);
     $this->Cell(130,0,'',0,0);
     $this->Cell(60,40,'ANVI INDUSTRY',0,0);
...
$this->SetFillColor(176,218,249);
$this->Cell(185,10,'                                                            TAX INVOICE',1,20,'L',true);
...
// Background color?php
     ...
     $this->SetFillColor(249,195,139);

     $this->Cell(185,8,"Customer Details ",1,20,'L',true);
     $this->SetXY($x+20, $y+0.8);
  
     $this->Ln(13);
    // $this->SetFillColor(255,255,255);
     $this->SetFont('Arial','',10);
     $this->Cell(40,0,'Customer Name -',0,0);
     $this->Cell(70,0,'XYZ',0,0);
    ...
    // $this->SetXY($x-550, $y+0.9);
     ...
     $this->Cell(92,0,'Pragati Engg Work pvt.ltd.',0,0);
     $this->Cell(15,0,'Date -',0,0);
     $this->Cell(6,0,'23/12/2020',0,0);
     $this->Ln(6);
     $this->SetFont('Arial','',10);
     $this->Cell(20,0,'Address -',0,0);
     $this->Cell(97,0,'a/p paluse colony',0,0);
     $this->Cell(20,0,'Tax Due -',0,0);
     $this->Cell(6,0,'5800',0,0);
     $this->Ln(6);
     $this->SetFont('Arial','',10);
     $this->Cell(20,0,'Mobile -',0,0);
     $this->Cell(17,0,'7776845553',0,0);
     $this->Ln(6);
     $this->SetFont('Arial','',10);
     $this->Cell(20,0,'Mail -',0,0);
     $this->Cell(17,0,'abhi.t@gmail.com',0,0);
