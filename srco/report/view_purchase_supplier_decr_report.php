                                ...
                                <div class="row" style="margin: 0;">
                                    <div class="col-lg-2 col-md-2 col-sm-2 mobile-width border-right-blue-grey border-right-lighten-5">
                                        <div class="btn-group">
                                            ...
                                            Supplier Mannual Debit Credit Report
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="supplier" class="select2" data-toggle="select2" name="supplier">
                                                                ...
                                                                <?php 
                                                                    $get_supplier_id = "SELECT DISTINCT supplier_id_fk FROM supplier_manual_debit_credit";
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="dc_no" class="select2" data-toggle="select2" name="dc_no">
                                                                <option value="" disabled selected>Select </option>
                                                                <?php
                                                                    $get_dcno = "SELECT id, debit_credit_no FROM supplier_manual_debit_credit";
                                                                    $res_dcno = mysqli_query($db, $get_dcno) or die(mysqli_error($db));

                                                                    while($row2 = mysqli_fetch_row($res_dcno))
                                                                    {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput1">Against</label>
                                                        <div class="col-md-9">
                                                            <input class="checkbox" type="checkbox" id="debit" name="debit" />&nbsp;Debit &nbsp;&nbsp;
                                                            <input class="checkbox" type="checkbox" id="credit" name="credit" />&nbsp;Credit
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
...
<script>
    function show_data()
    {
        ...
        var dc_no = document.getElementById('dc_no').value;
        var all_no = document.getElementById('all_no'); // all pono checkbox
        var a_status = document.getElementById('active');
        var c_status = document.getElementById('cancel');
        var debit = document.getElementById('debit');
        var credit = document.getElementById('credit');

        $.ajax({
            url: '../../api/report/supplier_manual_decr_report.php',
            type: 'POST',
            data: {
                'supplier': supplier,
                'dc_no': dc_no
            ...
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var dcno=`<p>${data[index].dcno}</p>`;
                    var date=`<p>${data[index].date}</p>`;
                    var final_amount= `<p>${data[index].final_amt}</p>`;
