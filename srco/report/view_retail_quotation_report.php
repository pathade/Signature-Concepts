                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">Quotation No</label>
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="quotation_no" class="select2" data-toggle="select2" name="quotation_no">
                                                                <option value="" disabled selected>Select </option>
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/retail_quotation_report.php',
            type: 'POST',
            data: {
