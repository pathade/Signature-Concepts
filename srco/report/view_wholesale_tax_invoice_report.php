                                            ...
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label class="col-md-3 label-control" for="userinput1">Amount</label>
                                                        <div class="col-md-9">
                                                            <input class="checkbox" type="checkbox" id="paid" name="paid" />&nbsp;Paid &nbsp;&nbsp;
                                                            <input class="checkbox" type="checkbox" id="unpaid" name="unpaid" />&nbsp;Unpaid
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/wholesale_tax_invoice_report.php',
            type: 'POST',
            data: {
            ...
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var received_amount= `<p>${data[index].received_amt}</p>`;
