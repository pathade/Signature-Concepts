                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-2 mt-1">
                                                    <div class="form-group row">
                                                        <input class="checkbox" type="checkbox" id="all_branch" name="all_branch" />&nbsp;&nbsp;All Branch
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">Item Type</label>
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="item_type" class="select2" data-toggle="select2" name="item_type">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">CM Code</label>
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="cm_code" class="select2" data-toggle="select2" name="cm_code">
                                                                <option value="" disabled selected>Select </option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">Supplier Design Code</label>
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="supp_design_code" class="select2" data-toggle="select2" name="supp_design_code">
                                                                <option value="" disabled selected>Select </option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">PCS/Box</label>
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="pcs_box" class="select2" data-toggle="select2" name="pcs_box">
                                                                <option value="" disabled selected>Select </option>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-md-2 label-control" for="userinput1">Product</label>
                                                        <div class="col-md-10 divcol">
                                                            <select class="select2 form-control block" id="product" class="select2" data-toggle="select2" name="product">
                                                                <option value="" disabled selected>Select </option>
                                                ...
                                                <div class="col-md-1 mt-1">
                                                    <div class="form-group row">
                                                        <input class="checkbox" type="checkbox" id="all_detail" name="all_detail" />&nbsp;&nbsp;Detail
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
