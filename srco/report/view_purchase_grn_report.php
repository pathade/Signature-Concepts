                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="supplier" class="select2" data-toggle="select2" name="supplier">
                                                                ...
                                                                <?php 
                                                                    $get_supplier_id = "SELECT DISTINCT supplier FROM grn";
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="grn_no" class="select2" data-toggle="select2" name="grn_no">
                                                                <option value="" disabled selected>Select </option>
                                                                <?php
                                                                    $get_grn = "SELECT grn_id_pk, grn_no FROM grn";
                                                                    $res_grn = mysqli_query($db, $get_grn) or die(mysqli_error($db));

                                                                    while($row2 = mysqli_fetch_row($res_grn))
                                                                    {
                                                ...
                                                <div class="col-md-1 mt-1">
                                                    <div class="form-group row">
                                                        <input class="checkbox" type="checkbox" id="all_grn_no" name="all_grn_no" />&nbsp;&nbsp;All
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="po_no" class="select2" data-toggle="select2" name="po_no">
                                                                <option value="" disabled selected>Select </option>
                                                                <?php 
                                                                    $get_po_id = "SELECT DISTINCT po_id_fk FROM grn";
                                                                    $res_po_id = mysqli_query($db, $get_po_id) or die(mysqli_error($db));
                                                                    while($row3 = mysqli_fetch_row($res_po_id))
                                                                    {
                                                                        $get_pono = "SELECT purchase_order_no FROM purchase_order WHERE id='$row3[0]'";
                                                                        $res_pono = mysqli_fetch_row(mysqli_query($db, $get_pono));

                                                                        echo '<option value="'.$row3[0].'">'.$res_pono[0].'</option>';
                                                                    }
                                                                ?>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput1">Invoice Status</label>
                                                        <div class="col-md-9">
                                                            <input class="checkbox" type="checkbox" id="yes" name="yes" />&nbsp;Yes &nbsp;&nbsp;
                                                            <input class="checkbox" type="checkbox" id="no" name="no" />&nbsp;No
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    function show_data()
    {
        ...
        var all_no = document.getElementById('all_grn_no'); // all pono checkbox
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var grn_no=`<p>${data[index].grn_no}</p>`;
                    ...
                    var invoice_status= `${data[index].invoice_status}`;
