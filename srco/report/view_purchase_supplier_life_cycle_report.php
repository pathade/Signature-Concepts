...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/supplier_life_cycle_report.php',
            type: 'POST',
            data: {
            ...
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var select = '';
                    var supplier=`<p>${data[index].supplier_name}</p>`;
                    var pono=`<p>${data[index].pono}</p>`;
                    var po_date=`<p>${data[index].po_date}</p>`;
                    var grn_no=`<p>${data[index].grn_no}</p>`;
                    var grn_date=`<p>${data[index].grn_date}</p>`;
                    var pino=`<p>${data[index].pino}</p>`;
                    var pi_date=`<p>${data[index].pi_date}</p>`;
