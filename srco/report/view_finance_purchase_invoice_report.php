                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-1 mt-1">
                                                    <div class="form-group row">
                                                        <input class="checkbox" type="checkbox" id="all_bill_no" name="all_bill_no" />&nbsp;&nbsp;All
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/finance_purchase_invoice_report.php',
            type: 'POST',
            data: {
            },
            dataType: 'json',
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var gross_amount= `<p>${data[index].gross_amt}</p>`;
                    var disc= `<p>${data[index].discount}</p>`;
                    var unload= `<p>${data[index].unload}</p>`;
                    var tax_amt= `<p>${data[index].tax_amt}</p>`;
                    var others= `<p>${data[index].others}</p>`;
