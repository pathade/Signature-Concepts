...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/wholesale_pending_report.php',
            type: 'POST',
            data: {
            ...
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var item=`<p>${data[index].item}</p>`;
                    var o_qty=`<p>${data[index].o_qty}</p>`;
                    var p_qty=`<p>${data[index].p_qty}</p>`;
                    var process=`<p>${data[index].process}</p>`;
                    var sides=`<p>${data[index].sides}</p>`;
