                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row" style="margin-left: 0px;">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">Retail Customer</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">P Invoice No</label>
                                                        <div class="col-md-9">
                                                            <select class="select2 form-control block" id="pi_no" class="select2" data-toggle="select2" name="pi_no">
                                                                <option value="" disabled selected>Select </option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput1">Balance</label>
                                                        <div class="col-md-9">
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/retail_return_good_report.php',
            type: 'POST',
            data: {
