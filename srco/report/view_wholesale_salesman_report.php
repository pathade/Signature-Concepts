                                            ...
                                            <div class="form-group row" style="margin-left: 0px;">
                                                <div class="col-md-5">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput1">Comapny</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="col-md-1 mt-1">
                                                    <div class="form-group row">
                                                        <input class="checkbox" type="checkbox" id="all_salesman" name="all_salesman" />&nbsp;&nbsp;All
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group row">
...
<script>
    function show_data()
    {
        ...
        $.ajax({
            url: '../../api/report/wholesale_salesman_report.php',
            type: 'POST',
            data: {
            },
            dataType: 'json',
            success: function(data){
                ...
                $.each(data, function(index) 
                {
                    ...
                    var select = '';
                    var company=`<p>${data[index].company}</p>`;
